...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1348.85 | 18340.80 | 110.5% | 99.8% |
| **API bench (installed)** | 1350.90 | 18312.98 | 110.6% | — |
| **hipblaslt-bench (stock)** | 1220.93 | 20262.40 | — | — |

> **Tuned/API ratio (gate metric):** 99.85%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 40960 -k 18432 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,16384,40960,18432,1,16384,301989888,0,18432,754974720,16384,671088640,16384,671088640,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.22093e+06,158.854,20262.4
