...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1420.14 | 1354.90 | 114.5% | 99.3% |
| **API bench (installed)** | 1430.34 | 1345.23 | 115.3% | — |
| **hipblaslt-bench (stock)** | 1240.71 | 1550.84 | — | — |

> **Tuned/API ratio (gate metric):** 99.29%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 57344 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,4096,57344,4096,1,4096,16777216,0,4096,234881024,4096,234881024,4096,234881024,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.24071e+06,584.361,1550.84
