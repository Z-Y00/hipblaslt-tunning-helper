...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1371.10 | 62549.50 | 109.2% | 96.8% |
| **API bench (installed)** | 1416.32 | 60552.62 | 112.8% | — |
| **hipblaslt-bench (stock)** | 1255.56 | 68305.90 | — | — |

> **Tuned/API ratio (gate metric):** 96.81%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 24576 -k 106496 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,16384,24576,106496,1,16384,1744830464,0,106496,2617245696,16384,402653184,16384,402653184,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.25556e+06,129.93,68305.9
