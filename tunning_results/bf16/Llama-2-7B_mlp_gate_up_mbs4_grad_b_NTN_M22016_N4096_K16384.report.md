...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1330.09 | 2221.61 | 122.9% | 111.0% |
| **API bench (installed)** | 1198.19 | 2466.16 | 110.7% | — |
| **hipblaslt-bench (stock)** | 1082.66 | 2729.34 | — | — |

> **Tuned/API ratio (gate metric):** 111.01%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 22016 -k 16384 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,22016,16384,1,4096,67108864,0,22016,360710144,4096,90177536,4096,90177536,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.08266e+06,353.508,2729.34
