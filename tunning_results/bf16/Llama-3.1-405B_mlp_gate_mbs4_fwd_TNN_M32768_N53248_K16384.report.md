...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1418.07 | 40318.50 | 116.5% | 97.0% |
| **API bench (installed)** | 1462.56 | 39092.27 | 120.2% | — |
| **hipblaslt-bench (stock)** | 1216.87 | 46984.80 | — | — |

> **Tuned/API ratio (gate metric):** 96.96%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 53248 -n 32768 -k 16384 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,53248,32768,16384,1,16384,872415232,0,16384,536870912,53248,1744830464,53248,1744830464,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.21687e+06,125.04,46984.8
