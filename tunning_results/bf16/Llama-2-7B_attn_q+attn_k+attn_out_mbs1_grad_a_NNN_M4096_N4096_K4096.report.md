...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1168.20 | 117.65 | 116.5% | 103.7% |
| **API bench (installed)** | 1126.52 | 122.00 | 112.4% | — |
| **hipblaslt-bench (stock)** | 1002.33 | 137.12 | — | — |

> **Tuned/API ratio (gate metric):** 103.70%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 4096 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 640 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,4096,4096,1,4096,16777216,0,4096,16777216,4096,16777216,4096,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,640,0,0,1.00233e+06,683.708,137.12
