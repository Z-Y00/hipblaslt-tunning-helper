...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1340.82 | 1435.05 | 124.4% | 109.0% |
| **API bench (installed)** | 1230.43 | 1563.80 | 114.2% | — |
| **hipblaslt-bench (stock)** | 1077.46 | 1785.82 | — | — |

> **Tuned/API ratio (gate metric):** 108.97%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 14336 -n 16384 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,14336,16384,4096,1,14336,58720256,0,4096,67108864,14336,234881024,14336,234881024,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.07746e+06,376.228,1785.82
