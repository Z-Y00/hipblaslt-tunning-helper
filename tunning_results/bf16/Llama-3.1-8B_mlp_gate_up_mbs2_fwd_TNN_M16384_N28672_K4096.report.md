...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1317.18 | 2921.60 | 151.9% | 129.4% |
| **API bench (installed)** | 1017.61 | 3781.70 | 117.4% | — |
| **hipblaslt-bench (stock)** | 867.02 | 4438.54 | — | — |

> **Tuned/API ratio (gate metric):** 129.44%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 28672 -n 16384 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,28672,16384,4096,1,4096,117440512,0,4096,67108864,28672,469762048,28672,469762048,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,867017,274.584,4438.54
