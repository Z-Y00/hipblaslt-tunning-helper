...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1047.22 | 590.59 | 103.6% | 3486.8% |
| **API bench (installed)** | 30.03 | 20592.82 | 3.0% | — |
| **hipblaslt-bench (stock)** | 1010.45 | 612.08 | — | — |

> **Tuned/API ratio (gate metric):** 3486.84%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 36864 -k 1024 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,36864,1024,1,8192,8388608,0,1024,37748736,8192,301989888,8192,301989888,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.01045e+06,1059.4,612.08
