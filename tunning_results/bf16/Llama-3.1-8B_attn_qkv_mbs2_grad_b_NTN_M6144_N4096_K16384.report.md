...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1249.18 | 660.14 | 130.6% | 119.2% |
| **API bench (installed)** | 1047.74 | 787.06 | 109.5% | — |
| **hipblaslt-bench (stock)** | 956.65 | 862.00 | — | — |

> **Tuned/API ratio (gate metric):** 119.23%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 6144 -k 16384 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 2080 --print_kernel_info
```
...
Rotating buffer 2080 MiB. Needed Size: 368 MiB. Needed block count: 1 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,6144,16384,1,4096,67108864,0,6144,100663296,4096,25165824,4096,25165824,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2080,0,0,956652,416.908,862
