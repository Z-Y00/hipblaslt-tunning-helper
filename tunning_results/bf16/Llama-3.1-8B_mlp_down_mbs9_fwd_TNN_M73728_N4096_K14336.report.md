...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1461.96 | 5922.64 | 113.1% | 99.3% |
| **API bench (installed)** | 1471.84 | 5882.86 | 113.9% | — |
| **hipblaslt-bench (stock)** | 1292.47 | 6699.32 | — | — |

> **Tuned/API ratio (gate metric):** 99.33%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 73728 -k 14336 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,4096,73728,14336,1,14336,58720256,0,14336,1056964608,4096,301989888,4096,301989888,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.29247e+06,394.163,6699.32
