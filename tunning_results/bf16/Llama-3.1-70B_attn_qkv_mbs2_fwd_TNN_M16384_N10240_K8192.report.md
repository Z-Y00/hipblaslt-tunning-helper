...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1247.02 | 2204.28 | 99.8% | 87.2% |
| **API bench (installed)** | 1430.67 | 1921.32 | 114.5% | — |
| **hipblaslt-bench (stock)** | 1249.10 | 2200.61 | — | — |

> **Tuned/API ratio (gate metric):** 87.16%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 10240 -n 16384 -k 8192 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,10240,16384,8192,1,8192,83886080,0,8192,134217728,10240,167772160,10240,167772160,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.2491e+06,326.614,2200.61
