...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1334.65 | 11533.40 | 109.2% | 97.7% |
| **API bench (installed)** | 1366.24 | 11266.79 | 111.8% | — |
| **hipblaslt-bench (stock)** | 1222.39 | 12592.70 | — | — |

> **Tuned/API ratio (gate metric):** 97.69%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 57344 -k 16384 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,57344,16384,1,8192,134217728,0,57344,939524096,8192,469762048,8192,469762048,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.22239e+06,228.307,12592.7
