...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1370.74 | 8422.37 | 122.5% | 114.0% |
| **API bench (installed)** | 1202.92 | 9597.38 | 107.5% | — |
| **hipblaslt-bench (stock)** | 1118.84 | 10318.60 | — | — |

> **Tuned/API ratio (gate metric):** 113.95%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 24576 -k 28672 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,24576,28672,1,8192,234881024,0,28672,704643072,8192,201326592,8192,201326592,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.11884e+06,205.938,10318.6
