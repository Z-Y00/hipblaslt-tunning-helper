...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1328.37 | 5793.99 | 109.3% | 95.5% |
| **API bench (installed)** | 1391.36 | 5531.69 | 114.5% | — |
| **hipblaslt-bench (stock)** | 1215.59 | 6331.58 | — | — |

> **Tuned/API ratio (gate metric):** 95.47%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 28672 -n 32768 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,28672,32768,4096,1,4096,117440512,0,4096,134217728,28672,939524096,28672,939524096,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.21559e+06,350.426,6331.58
