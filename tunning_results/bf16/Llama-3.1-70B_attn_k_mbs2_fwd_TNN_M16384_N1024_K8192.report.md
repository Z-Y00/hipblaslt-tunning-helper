...
| **API bench (installed)** | 1211.77 | 226.84 | 111.4% | — |
| **hipblaslt-bench (stock)** | 1087.85 | 252.68 | — | — |
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 1024 -n 16384 -k 8192 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 2100 --print_kernel_info
```
...
Rotating buffer 2100 MiB. Needed Size: 304 MiB. Needed block count: 1 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,1024,16384,8192,1,8192,8388608,0,8192,134217728,1024,16777216,1024,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2100,0,0,1.08785e+06,1174.91,252.68
