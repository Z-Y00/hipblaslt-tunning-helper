# Llama-3.1-405B — mlp_gate [grad_b]
...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1215.02 | 70584.90 | 117.8% | 96.7% |
| **API bench (installed)** | 1255.86 | 68289.22 | 121.8% | — |
| **hipblaslt-bench (stock)** | 1031.25 | 83163.40 | — | — |

> **Tuned/API ratio (gate metric):** 96.75%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 53248 -k 49152 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,53248,49152,1,16384,805306368,0,53248,2617245696,16384,872415232,16384,872415232,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.03125e+06,96.1962,83163.4
