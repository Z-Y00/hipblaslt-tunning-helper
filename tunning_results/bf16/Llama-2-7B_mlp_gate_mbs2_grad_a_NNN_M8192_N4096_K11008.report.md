...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1431.78 | 515.96 | 113.5% | 99.3% |
| **API bench (installed)** | 1442.24 | 512.21 | 114.3% | — |
| **hipblaslt-bench (stock)** | 1261.97 | 585.38 | — | — |

> **Tuned/API ratio (gate metric):** 99.27%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 8192 -k 11008 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 1930 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,8192,11008,1,4096,45088768,0,11008,90177536,4096,33554432,4096,33554432,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1930,0,0,1.26197e+06,537.178,585.38
