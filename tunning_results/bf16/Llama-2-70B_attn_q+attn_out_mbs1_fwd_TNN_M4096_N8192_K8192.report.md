...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1356.14 | 405.38 | 113.3% | 95.6% |
| **API bench (installed)** | 1418.57 | 387.54 | 118.5% | — |
| **hipblaslt-bench (stock)** | 1197.41 | 459.12 | — | — |

> **Tuned/API ratio (gate metric):** 95.60%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 4096 -k 8192 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 1600 --print_kernel_info
```
...
Rotating buffer 1600 MiB. Needed Size: 256 MiB. Needed block count: 7 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,8192,4096,8192,1,8192,67108864,0,8192,33554432,8192,33554432,8192,33554432,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1600,0,0,1.19741e+06,544.52,459.12
