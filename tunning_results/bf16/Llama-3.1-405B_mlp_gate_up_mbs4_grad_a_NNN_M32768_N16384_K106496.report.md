...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1252.63 | 91287.30 | 136.6% | 124.2% |
| **API bench (installed)** | 1008.37 | 113400.54 | 110.0% | — |
| **hipblaslt-bench (stock)** | 916.75 | 124733.00 | — | — |

> **Tuned/API ratio (gate metric):** 124.22%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 32768 -k 106496 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,16384,32768,106496,1,16384,1744830464,0,106496,3489660928,16384,536870912,16384,536870912,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,916752,86.1841,124733
