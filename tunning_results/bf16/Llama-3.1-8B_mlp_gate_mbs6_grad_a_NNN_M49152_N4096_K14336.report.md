...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1448.13 | 3986.13 | 115.4% | 98.1% |
| **API bench (installed)** | 1476.28 | 3910.13 | 117.6% | — |
| **hipblaslt-bench (stock)** | 1255.41 | 4598.06 | — | — |

> **Tuned/API ratio (gate metric):** 98.09%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 49152 -k 14336 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,49152,14336,1,4096,58720256,0,14336,704643072,4096,201326592,4096,201326592,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.25541e+06,390.79,4598.06
