...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1113.99 | 370.13 | 311.5% | 1183.3% |
| **API bench (installed)** | 94.14 | 4379.67 | 26.3% | — |
| **hipblaslt-bench (stock)** | 357.63 | 1152.92 | — | — |

> **Tuned/API ratio (gate metric):** 1183.29%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 1024 -k 49152 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 2480 --print_kernel_info
```
...
Rotating buffer 2480 MiB. Needed Size: 488 MiB. Needed block count: 1 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,1024,49152,1,4096,201326592,0,1024,50331648,4096,4194304,4096,4194304,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2480,0,0,357628,413.353,1152.92
