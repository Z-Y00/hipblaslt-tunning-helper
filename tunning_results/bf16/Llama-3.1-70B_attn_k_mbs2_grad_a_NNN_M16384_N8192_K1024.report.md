...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 903.25 | 304.32 | 96.6% | 87.7% |
| **API bench (installed)** | 1030.44 | 266.76 | 110.2% | — |
| **hipblaslt-bench (stock)** | 935.23 | 293.92 | — | — |

> **Tuned/API ratio (gate metric):** 87.66%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 16384 -k 1024 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,16384,1024,1,8192,8388608,0,1024,16777216,8192,134217728,8192,134217728,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,935225,1010.07,293.916
