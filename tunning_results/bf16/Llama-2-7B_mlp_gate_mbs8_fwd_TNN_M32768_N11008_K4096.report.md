...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1349.78 | 2189.20 | 112.4% | 101.3% |
| **API bench (installed)** | 1332.47 | 2217.64 | 111.0% | — |
| **hipblaslt-bench (stock)** | 1200.92 | 2460.56 | — | — |

> **Tuned/API ratio (gate metric):** 101.30%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 11008 -n 32768 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,11008,32768,4096,1,4096,45088768,0,4096,134217728,11008,360710144,11008,360710144,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.20092e+06,408.793,2460.56
