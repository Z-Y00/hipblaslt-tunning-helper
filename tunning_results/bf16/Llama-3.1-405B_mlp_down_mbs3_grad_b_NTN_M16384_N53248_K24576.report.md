...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1173.40 | 36544.20 | 116.1% | 93.9% |
| **API bench (installed)** | 1248.97 | 34332.92 | 123.6% | — |
| **hipblaslt-bench (stock)** | 1010.36 | 42441.40 | — | — |

> **Tuned/API ratio (gate metric):** 93.95%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 53248 -n 16384 -k 24576 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,53248,16384,24576,1,53248,1308622848,0,16384,402653184,53248,872415232,53248,872415232,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.01036e+06,113.392,42441.4
