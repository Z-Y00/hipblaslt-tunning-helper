...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1331.27 | 20234.80 | 112.7% | 98.5% |
| **API bench (installed)** | 1352.22 | 19921.29 | 114.5% | — |
| **hipblaslt-bench (stock)** | 1181.45 | 22800.80 | — | — |

> **Tuned/API ratio (gate metric):** 98.45%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 57344 -k 28672 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,57344,28672,1,8192,234881024,0,57344,1644167168,8192,469762048,8192,469762048,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.18145e+06,191.879,22800.8
