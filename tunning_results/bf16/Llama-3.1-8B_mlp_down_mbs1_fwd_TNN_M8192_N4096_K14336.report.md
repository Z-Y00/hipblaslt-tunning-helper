...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1424.70 | 675.28 | 216.4% | 221.1% |
| **API bench (installed)** | 644.42 | 1492.92 | 97.9% | — |
| **hipblaslt-bench (stock)** | 658.24 | 1461.58 | — | — |

> **Tuned/API ratio (gate metric):** 221.08%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 8192 -k 14336 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 2320 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,4096,8192,14336,1,14336,58720256,0,14336,117440512,4096,33554432,4096,33554432,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2320,0,0,658242,267.262,1461.58
