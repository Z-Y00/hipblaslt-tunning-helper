...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1324.39 | 1673.38 | 119.1% | 107.9% |
| **API bench (installed)** | 1227.81 | 1805.00 | 110.5% | — |
| **hipblaslt-bench (stock)** | 1111.56 | 1993.78 | — | — |

> **Tuned/API ratio (gate metric):** 107.87%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 22016 -k 12288 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,22016,12288,1,4096,50331648,0,22016,270532608,4096,90177536,4096,90177536,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.11156e+06,384.007,1993.78
