...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1419.50 | 2341.88 | 117.3% | 103.4% |
| **API bench (installed)** | 1373.15 | 2420.93 | 113.5% | — |
| **hipblaslt-bench (stock)** | 1210.18 | 2746.94 | — | — |

> **Tuned/API ratio (gate metric):** 103.38%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 11008 -n 36864 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,11008,36864,4096,1,4096,45088768,0,4096,150994944,11008,405798912,11008,405798912,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.21018e+06,408.125,2746.94
