...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1396.70 | 1476.04 | 201.3% | 173.9% |
| **API bench (installed)** | 803.36 | 2566.19 | 115.8% | — |
| **hipblaslt-bench (stock)** | 693.81 | 2971.38 | — | — |

> **Tuned/API ratio (gate metric):** 173.86%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 12288 -k 10240 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,12288,10240,1,8192,83886080,0,10240,125829120,8192,100663296,8192,100663296,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,693814,194.564,2971.38
