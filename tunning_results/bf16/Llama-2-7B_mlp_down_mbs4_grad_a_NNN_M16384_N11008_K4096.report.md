...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1315.22 | 1123.36 | 112.2% | 98.7% |
| **API bench (installed)** | 1332.74 | 1108.59 | 113.7% | — |
| **hipblaslt-bench (stock)** | 1171.98 | 1260.66 | — | — |

> **Tuned/API ratio (gate metric):** 98.69%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 11008 -n 16384 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,11008,16384,4096,1,11008,45088768,0,4096,67108864,11008,180355072,11008,180355072,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.17198e+06,432.251,1260.66
