# Llama-3.1-8B — attn_q+attn_out [fwd]
...
| **API bench (installed)** | 1251.67 | 219.61 | 111.1% | — |
| **hipblaslt-bench (stock)** | 1126.41 | 244.03 | — | — |
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 8192 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 1400 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,4096,8192,4096,1,4096,16777216,0,4096,33554432,4096,33554432,4096,33554432,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1400,1,1,1.12641e+06,640.291,244.03
