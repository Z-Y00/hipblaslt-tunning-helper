...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1467.01 | 2997.96 | 115.2% | 101.8% |
| **API bench (installed)** | 1441.43 | 3051.16 | 113.2% | — |
| **hipblaslt-bench (stock)** | 1273.39 | 3453.82 | — | — |

> **Tuned/API ratio (gate metric):** 101.77%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,32768,8192,1,8192,67108864,0,8192,268435456,8192,268435456,8192,268435456,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.27339e+06,325.726,3453.82
