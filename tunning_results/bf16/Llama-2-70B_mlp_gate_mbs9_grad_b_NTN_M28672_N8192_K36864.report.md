...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1344.24 | 12882.60 | 114.2% | 100.2% |
| **API bench (installed)** | 1342.19 | 12902.27 | 114.0% | — |
| **hipblaslt-bench (stock)** | 1177.46 | 14707.30 | — | — |

> **Tuned/API ratio (gate metric):** 100.15%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 28672 -k 36864 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,28672,36864,1,8192,301989888,0,28672,1056964608,8192,234881024,8192,234881024,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.17746e+06,201.855,14707.3
