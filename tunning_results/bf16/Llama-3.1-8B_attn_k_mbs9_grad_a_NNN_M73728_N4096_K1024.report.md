...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1048.30 | 589.98 | 102.5% | 91.8% |
| **API bench (installed)** | 1141.56 | 541.78 | 111.7% | — |
| **hipblaslt-bench (stock)** | 1022.37 | 604.94 | — | — |

> **Tuned/API ratio (gate metric):** 91.83%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 73728 -k 1024 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,73728,1024,1,4096,4194304,0,1024,75497472,4096,301989888,4096,301989888,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.02237e+06,1175.22,604.94
