...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1446.27 | 2660.84 | 111.3% | 98.4% |
| **API bench (installed)** | 1469.36 | 2619.02 | 113.1% | — |
| **hipblaslt-bench (stock)** | 1298.98 | 2962.54 | — | — |

> **Tuned/API ratio (gate metric):** 98.43%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 4096 -k 57344 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,4096,57344,1,8192,469762048,0,57344,234881024,8192,33554432,8192,33554432,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.29898e+06,464.129,2962.54
