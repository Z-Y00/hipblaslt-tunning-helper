...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1234.29 | 3117.81 | 99.0% | 84.8% |
| **API bench (installed)** | 1455.85 | 2643.33 | 116.8% | — |
| **hipblaslt-bench (stock)** | 1246.54 | 3087.17 | — | — |

> **Tuned/API ratio (gate metric):** 84.78%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 4096 -k 57344 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,4096,57344,1,8192,469762048,0,57344,234881024,8192,33554432,8192,33554432,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.24654e+06,445.392,3087.17
