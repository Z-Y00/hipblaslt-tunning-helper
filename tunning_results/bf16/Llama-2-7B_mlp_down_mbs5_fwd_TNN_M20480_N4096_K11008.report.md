...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1491.70 | 1238.07 | 115.1% | 99.1% |
| **API bench (installed)** | 1505.36 | 1226.84 | 116.2% | — |
| **hipblaslt-bench (stock)** | 1295.48 | 1425.60 | — | — |

> **Tuned/API ratio (gate metric):** 99.09%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 20480 -k 11008 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,4096,20480,11008,1,11008,45088768,0,11008,225443840,4096,83886080,4096,83886080,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.29548e+06,463.073,1425.6
