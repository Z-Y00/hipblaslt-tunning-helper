...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1311.96 | 314.27 | 113.9% | 100.7% |
| **API bench (installed)** | 1302.72 | 316.50 | 113.1% | — |
| **hipblaslt-bench (stock)** | 1151.85 | 357.96 | — | — |

> **Tuned/API ratio (gate metric):** 100.71%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 1024 -n 49152 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,1024,49152,4096,1,4096,4194304,0,4096,201326592,1024,50331648,1024,50331648,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.15185e+06,1331.33,357.96
