...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 771.55 | 5343.97 | 320.1% | 494.0% |
| **API bench (installed)** | 156.19 | 26399.01 | 64.8% | — |
| **hipblaslt-bench (stock)** | 241.04 | 17105.50 | — | — |

> **Tuned/API ratio (gate metric):** 494.00%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 10240 -n 24576 -k 8192 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,10240,24576,8192,1,8192,83886080,0,8192,201326592,10240,251658240,10240,251658240,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,241043,58.4607,17105.5
