...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 993.31 | 69.18 | 131.3% | 112.9% |
| **API bench (installed)** | 880.15 | 78.08 | 116.4% | — |
| **hipblaslt-bench (stock)** | 756.32 | 90.86 | — | — |

> **Tuned/API ratio (gate metric):** 112.86%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 4096 -k 1024 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 760 --print_kernel_info
```
...
Rotating buffer 760 MiB. Needed Size: 88 MiB. Needed block count: 9 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,4096,1024,1,8192,8388608,0,1024,4194304,8192,33554432,8192,33554432,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,760,0,0,756323,945.823,90.86
