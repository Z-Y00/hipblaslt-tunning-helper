...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1344.27 | 85064.10 | 111.8% | 99.5% |
| **API bench (installed)** | 1350.75 | 84656.24 | 112.3% | — |
| **hipblaslt-bench (stock)** | 1202.76 | 95072.10 | — | — |

> **Tuned/API ratio (gate metric):** 99.52%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 106496 -n 32768 -k 16384 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,106496,32768,16384,1,16384,1744830464,0,16384,536870912,106496,3489660928,106496,3489660928,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.20276e+06,113.072,95072.1
