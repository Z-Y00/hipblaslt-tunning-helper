...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1365.90 | 19721.80 | 112.1% | 100.1% |
| **API bench (installed)** | 1364.73 | 19738.69 | 112.0% | — |
| **hipblaslt-bench (stock)** | 1218.83 | 22101.60 | — | — |

> **Tuned/API ratio (gate metric):** 100.09%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 28672 -k 57344 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,28672,57344,1,8192,469762048,0,57344,1644167168,8192,234881024,8192,234881024,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.21883e+06,197.949,22101.6
