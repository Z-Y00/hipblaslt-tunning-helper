...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 939.70 | 4095.23 | 104.1% | 89.7% |
| **API bench (installed)** | 1047.74 | 3672.94 | 116.1% | — |
| **hipblaslt-bench (stock)** | 902.32 | 4264.90 | — | — |

> **Tuned/API ratio (gate metric):** 89.69%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,28672,8192,8192,1,28672,234881024,0,8192,67108864,28672,234881024,28672,234881024,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,902317,234.472,4264.9
