...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1370.04 | 4213.33 | 145.5% | 119.7% |
| **API bench (installed)** | 1144.51 | 5043.60 | 121.5% | — |
| **hipblaslt-bench (stock)** | 941.89 | 6128.54 | — | — |

> **Tuned/API ratio (gate metric):** 119.71%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 24576 -k 28672 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,24576,28672,1,4096,117440512,0,28672,704643072,4096,100663296,4096,100663296,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,941894,280.45,6128.54
