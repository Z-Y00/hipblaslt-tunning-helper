...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1441.03 | 1025.29 | 189.3% | 184.6% |
| **API bench (installed)** | 780.51 | 1892.96 | 102.5% | — |
| **hipblaslt-bench (stock)** | 761.22 | 1940.92 | — | — |

> **Tuned/API ratio (gate metric):** 184.63%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 8192 -k 22016 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,8192,22016,1,4096,90177536,0,22016,180355072,4096,33554432,4096,33554432,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,761221,291.824,1940.92
