...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1436.25 | 1543.05 | 150.2% | 155.0% |
| **API bench (installed)** | 926.82 | 2391.20 | 97.0% | — |
| **hipblaslt-bench (stock)** | 955.94 | 2318.36 | — | — |

> **Tuned/API ratio (gate metric):** 154.97%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 12288 -k 22016 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,12288,22016,1,4096,90177536,0,22016,270532608,4096,50331648,4096,50331648,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,955936,330.244,2318.36
