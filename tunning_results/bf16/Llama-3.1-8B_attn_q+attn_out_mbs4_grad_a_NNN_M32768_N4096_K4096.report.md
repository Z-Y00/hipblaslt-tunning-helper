...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1337.92 | 821.81 | 215.0% | 217.6% |
| **API bench (installed)** | 614.87 | 1788.21 | 98.8% | — |
| **hipblaslt-bench (stock)** | 622.40 | 1766.58 | — | — |

> **Tuned/API ratio (gate metric):** 217.60%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,32768,4096,1,4096,16777216,0,4096,134217728,4096,134217728,4096,134217728,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,622396,300.722,1766.58
