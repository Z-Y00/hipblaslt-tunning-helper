# DeepSeek-V2-Lite — mlp_gate [grad_a]
...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 905.77 | 202.71 | 122.4% | 119.5% |
| **API bench (installed)** | 758.22 | 242.16 | 102.5% | — |
| **hipblaslt-bench (stock)** | 740.08 | 248.09 | — | — |

> **Tuned/API ratio (gate metric):** 119.46%

## Kernels

- **Tensile winner**: `Cijk_Ailk_Bljk_BBS_BH_Bias_HA_S_SAV_UserArgs_MT256x256x32_MI32x32x1_SN_LDSB1_AFC1_AG0_AFEM1_AFEM1_ASEM1_CLR1_CADS0_DTLA0_DTLB0_DTVA0_DTVB0_DTVSM0_DPLB0_EPS0_ELFLR0_EMLLn1_FDSI0_GRPM1_GRVWA8_GRVWB8_GSU0_GSUAMB_GSUC0_GSUWGMRR0_GLS0_ISA950_IU1_K1_LDSTI0_LBSPPA0_LBSPPB512_LBSPPM0_LPA0_LPB8_LPM0_LRVW8_LWPMn1_MIAV0_MIWT2_8_MO40_MGRIPM1_NTn1_NTA0_NTB1_NTC0_NTD0_NTM0_NEPBS0_NLCA1_NLCB1_ONLL1_PGR2_PLR1_PKA1_SGROB0_SIA3_SS1_SU8_SUM0_SUS64_SPO0_SRVW0_SSO0_SVW2_SK3_SKFTR0_SKXCCM0_SGRO0_TIN0_TLDS1_TLDSMn1_ULSGRO0_USL1_UIOFGRO0_UPLRP0_USFGROn1_VSn1_VWA2_VWB8_WSGRA0_WSGRB0_WS64_WG128_2_1_WGM8_WGMXCC1_WGMXCCGn1`
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 2048 -n 4096 -k 10944 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 1002 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
Rotating buffer 1002 MiB. Needed Size: 144 MiB. Needed block count: 7 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,2048,4096,10944,1,2048,22413312,0,10944,44826624,2048,8388608,2048,8388608,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1002,1,1,740080,567.804,248.095
...
**hipblaslt-bench-only params:** `CMS`
