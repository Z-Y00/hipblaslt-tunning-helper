...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 999.68 | 5774.28 | 107.7% | 99.5% |
| **API bench (installed)** | 1004.31 | 5747.67 | 108.2% | — |
| **hipblaslt-bench (stock)** | 927.94 | 6220.72 | — | — |

> **Tuned/API ratio (gate metric):** 99.54%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 28672 -n 8192 -k 12288 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,28672,8192,12288,1,28672,352321536,0,8192,100663296,28672,234881024,28672,234881024,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,927937,205.965,6220.72
