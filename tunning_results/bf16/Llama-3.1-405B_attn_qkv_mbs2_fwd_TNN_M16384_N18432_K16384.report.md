...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1419.03 | 6973.48 | 111.7% | 96.9% |
| **API bench (installed)** | 1464.28 | 6757.98 | 115.3% | — |
| **hipblaslt-bench (stock)** | 1270.33 | 7789.82 | — | — |

> **Tuned/API ratio (gate metric):** 96.91%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 18432 -n 16384 -k 16384 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,18432,16384,16384,1,16384,301989888,0,16384,268435456,18432,301989888,18432,301989888,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.27033e+06,208.606,7789.82
