...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1345.60 | 5719.81 | 111.4% | 98.3% |
| **API bench (installed)** | 1368.82 | 5622.81 | 113.3% | — |
| **hipblaslt-bench (stock)** | 1207.70 | 6372.92 | — | — |

> **Tuned/API ratio (gate metric):** 98.30%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 16384 -k 28672 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,16384,28672,1,8192,234881024,0,28672,469762048,8192,134217728,8192,134217728,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.2077e+06,245.178,6372.92
