...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1367.76 | 2110.19 | 358.4% | 406.4% |
| **API bench (installed)** | 336.52 | 8576.58 | 88.2% | — |
| **hipblaslt-bench (stock)** | 381.61 | 7563.30 | — | — |

> **Tuned/API ratio (gate metric):** 406.44%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 12288 -n 28672 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,12288,28672,4096,1,4096,50331648,0,4096,117440512,12288,352321536,12288,352321536,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,381608,128.086,7563.3
