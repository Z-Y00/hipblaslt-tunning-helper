...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1436.23 | 1435.41 | 237.0% | 174.5% |
| **API bench (installed)** | 822.99 | 2504.99 | 135.8% | — |
| **hipblaslt-bench (stock)** | 606.12 | 3401.30 | — | — |

> **Tuned/API ratio (gate metric):** 174.51%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 20480 -k 12288 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,20480,12288,1,4096,50331648,0,12288,251658240,4096,83886080,4096,83886080,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,606117,211.316,3401.3
