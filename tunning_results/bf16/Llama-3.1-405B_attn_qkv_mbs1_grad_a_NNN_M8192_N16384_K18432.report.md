...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1360.01 | 3638.07 | 110.8% | 100.3% |
| **API bench (installed)** | 1355.58 | 3649.95 | 110.5% | — |
| **hipblaslt-bench (stock)** | 1227.20 | 4031.78 | — | — |

> **Tuned/API ratio (gate metric):** 100.33%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 8192 -k 18432 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,16384,8192,18432,1,16384,301989888,0,18432,150994944,16384,134217728,16384,134217728,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.2272e+06,271.282,4031.78
