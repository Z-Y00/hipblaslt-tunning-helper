...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1415.18 | 1942.35 | 113.1% | 98.5% |
| **API bench (installed)** | 1436.88 | 1913.01 | 114.8% | — |
| **hipblaslt-bench (stock)** | 1251.57 | 2196.26 | — | — |

> **Tuned/API ratio (gate metric):** 98.49%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,16384,10240,1,8192,83886080,0,10240,167772160,8192,134217728,8192,134217728,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.25157e+06,327.261,2196.26
