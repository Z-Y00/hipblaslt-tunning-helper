...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1467.21 | 2622.86 | 113.5% | 99.5% |
| **API bench (installed)** | 1474.50 | 2609.89 | 114.1% | — |
| **hipblaslt-bench (stock)** | 1292.33 | 2977.80 | — | — |

> **Tuned/API ratio (gate metric):** 99.51%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 32768 -k 14336 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,4096,32768,14336,1,14336,58720256,0,14336,469762048,4096,134217728,4096,134217728,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.29233e+06,414.526,2977.8
