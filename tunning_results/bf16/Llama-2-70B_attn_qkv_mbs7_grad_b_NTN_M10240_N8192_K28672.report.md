...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1400.47 | 3434.82 | 115.4% | 101.3% |
| **API bench (installed)** | 1382.74 | 3478.87 | 113.9% | — |
| **hipblaslt-bench (stock)** | 1213.65 | 3963.56 | — | — |

> **Tuned/API ratio (gate metric):** 101.28%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 10240 -k 28672 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,10240,28672,1,8192,234881024,0,10240,293601280,8192,83886080,8192,83886080,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.21365e+06,287.778,3963.56
