...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 980.16 | 140.22 | 130.4% | 119.2% |
| **API bench (installed)** | 822.35 | 167.13 | 109.4% | — |
| **hipblaslt-bench (stock)** | 751.69 | 182.84 | — | — |

> **Tuned/API ratio (gate metric):** 119.19%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,1024,8192,1,8192,67108864,0,1024,8388608,8192,8388608,8192,8388608,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1100,0,0,751690,854.572,182.84
