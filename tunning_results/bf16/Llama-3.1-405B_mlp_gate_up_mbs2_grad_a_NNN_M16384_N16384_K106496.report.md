# Llama-3.1-405B — mlp_gate_up [grad_a]
...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1336.05 | 42793.80 | 114.9% | 100.8% |
| **API bench (installed)** | 1325.02 | 43149.90 | 113.9% | — |
| **hipblaslt-bench (stock)** | 1162.90 | 49165.70 | — | — |

> **Tuned/API ratio (gate metric):** 100.83%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 16384 -k 106496 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,16384,16384,106496,1,16384,1744830464,0,106496,1744830464,16384,268435456,16384,268435456,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.1629e+06,142.376,49165.7
