...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1362.82 | 2016.98 | 112.3% | 100.0% |
| **API bench (installed)** | 1362.59 | 2017.32 | 112.2% | — |
| **hipblaslt-bench (stock)** | 1214.01 | 2264.22 | — | — |

> **Tuned/API ratio (gate metric):** 100.02%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 8192 -k 20480 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,8192,20480,1,8192,167772160,0,8192,167772160,8192,67108864,8192,67108864,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.21401e+06,331.24,2264.22
