...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1355.69 | 506.89 | 110.2% | 95.7% |
| **API bench (installed)** | 1416.96 | 484.98 | 115.2% | — |
| **hipblaslt-bench (stock)** | 1229.86 | 558.76 | — | — |

> **Tuned/API ratio (gate metric):** 95.68%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 10240 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 2320 --print_kernel_info
```
...
Rotating buffer 2320 MiB. Needed Size: 304 MiB. Needed block count: 1 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,10240,4096,1,8192,33554432,0,10240,41943040,8192,83886080,8192,83886080,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2320,0,0,1.22986e+06,531.31,558.76
