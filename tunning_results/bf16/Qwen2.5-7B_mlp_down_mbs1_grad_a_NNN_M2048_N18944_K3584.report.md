...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 927.06 | 299.98 | 103.0% | 95.2% |
| **API bench (installed)** | 973.96 | 285.54 | 108.2% | — |
| **hipblaslt-bench (stock)** | 900.34 | 308.88 | — | — |

> **Tuned/API ratio (gate metric):** 95.18%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 18944 -n 2048 -k 3584 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 1822 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,18944,2048,3584,1,18944,67895296,0,3584,7340032,18944,38797312,18944,38797312,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1822,1,1,900343,687.65,308.881
