...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1355.56 | 31633.50 | 116.7% | 95.5% |
| **API bench (installed)** | 1419.77 | 30202.81 | 122.2% | — |
| **hipblaslt-bench (stock)** | 1161.66 | 36913.60 | — | — |

> **Tuned/API ratio (gate metric):** 95.48%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 53248 -n 24576 -k 16384 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,53248,24576,16384,1,53248,872415232,0,16384,402653184,53248,1308622848,53248,1308622848,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.16166e+06,130.372,36913.6
