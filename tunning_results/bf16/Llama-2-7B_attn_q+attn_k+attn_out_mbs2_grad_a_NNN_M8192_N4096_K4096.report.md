# Llama-2-7B — attn_q+attn_k+attn_out [grad_a]
...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1218.21 | 225.64 | 113.2% | 98.2% |
| **API bench (installed)** | 1240.58 | 221.57 | 115.3% | — |
| **hipblaslt-bench (stock)** | 1076.26 | 255.40 | — | — |

> **Tuned/API ratio (gate metric):** 98.20%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 8192 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 1120 --print_kernel_info
```
...
Rotating buffer 1120 MiB. Needed Size: 160 MiB. Needed block count: 7 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,8192,4096,1,4096,16777216,0,4096,33554432,4096,33554432,4096,33554432,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1120,0,0,1.07626e+06,611.785,255.4
