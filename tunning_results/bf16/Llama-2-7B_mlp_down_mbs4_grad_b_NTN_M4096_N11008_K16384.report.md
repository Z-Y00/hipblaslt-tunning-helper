...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1225.99 | 1205.12 | 120.1% | 93.9% |
| **API bench (installed)** | 1306.17 | 1131.14 | 127.9% | — |
| **hipblaslt-bench (stock)** | 1020.94 | 1447.16 | — | — |

> **Tuned/API ratio (gate metric):** 93.86%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 11008 -n 4096 -k 16384 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,11008,4096,16384,1,11008,180355072,0,4096,67108864,11008,45088768,11008,45088768,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.02094e+06,376.546,1447.16
