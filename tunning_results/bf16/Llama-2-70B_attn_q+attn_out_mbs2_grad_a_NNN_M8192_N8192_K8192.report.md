...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1443.02 | 761.95 | 252.4% | 231.3% |
| **API bench (installed)** | 623.76 | 1762.72 | 109.1% | — |
| **hipblaslt-bench (stock)** | 571.70 | 1923.24 | — | — |

> **Tuned/API ratio (gate metric):** 231.34%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,8192,8192,1,8192,67108864,0,8192,67108864,8192,67108864,8192,67108864,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,571698,194.983,1923.24
