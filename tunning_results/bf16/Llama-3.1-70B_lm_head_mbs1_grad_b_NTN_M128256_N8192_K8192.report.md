...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1194.73 | 14408.50 | 97.5% | 89.9% |
| **API bench (installed)** | 1329.53 | 12947.59 | 108.4% | — |
| **hipblaslt-bench (stock)** | 1225.95 | 14041.50 | — | — |

> **Tuned/API ratio (gate metric):** 89.86%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 128256 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,128256,8192,1,8192,67108864,0,128256,1050673152,8192,1050673152,8192,1050673152,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.22595e+06,287.651,14041.5
