...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1372.50 | 10414.40 | 110.3% | 98.9% |
| **API bench (installed)** | 1387.70 | 10300.27 | 111.5% | — |
| **hipblaslt-bench (stock)** | 1244.40 | 11486.40 | — | — |

> **Tuned/API ratio (gate metric):** 98.90%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 53248 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,53248,8192,1,16384,134217728,0,53248,436207616,16384,872415232,16384,872415232,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.2444e+06,233.973,11486.4
