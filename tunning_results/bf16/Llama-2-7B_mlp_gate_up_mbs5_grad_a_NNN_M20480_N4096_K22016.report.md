...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1381.40 | 2673.86 | 178.4% | 168.7% |
| **API bench (installed)** | 819.00 | 4509.97 | 105.8% | — |
| **hipblaslt-bench (stock)** | 774.24 | 4770.70 | — | — |

> **Tuned/API ratio (gate metric):** 168.67%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 20480 -k 22016 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,20480,22016,1,4096,90177536,0,22016,450887680,4096,83886080,4096,83886080,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,774241,244.002,4770.7
