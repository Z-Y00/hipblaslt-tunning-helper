...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1225.57 | 6280.01 | 98.7% | 88.2% |
| **API bench (installed)** | 1389.68 | 5538.40 | 111.9% | — |
| **hipblaslt-bench (stock)** | 1241.81 | 6197.88 | — | — |

> **Tuned/API ratio (gate metric):** 88.19%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 8192 -k 57344 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,8192,57344,1,8192,469762048,0,57344,469762048,8192,67108864,8192,67108864,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.24181e+06,302.523,6197.88
