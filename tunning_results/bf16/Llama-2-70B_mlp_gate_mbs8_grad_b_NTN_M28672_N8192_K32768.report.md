...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1282.97 | 11998.10 | 111.1% | 97.7% |
| **API bench (installed)** | 1313.79 | 11716.57 | 113.7% | — |
| **hipblaslt-bench (stock)** | 1155.12 | 13326.10 | — | — |

> **Tuned/API ratio (gate metric):** 97.65%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,28672,32768,1,8192,268435456,0,28672,939524096,8192,234881024,8192,234881024,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.15512e+06,201.672,13326.1
