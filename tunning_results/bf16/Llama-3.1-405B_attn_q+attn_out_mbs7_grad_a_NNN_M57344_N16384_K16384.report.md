...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1329.82 | 23150.80 | 125.7% | 109.0% |
| **API bench (installed)** | 1219.61 | 25242.87 | 115.2% | — |
| **hipblaslt-bench (stock)** | 1058.25 | 29091.70 | — | — |

> **Tuned/API ratio (gate metric):** 109.04%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 57344 -k 16384 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,16384,57344,16384,1,16384,268435456,0,16384,939524096,16384,939524096,16384,939524096,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.05825e+06,137.496,29091.7
