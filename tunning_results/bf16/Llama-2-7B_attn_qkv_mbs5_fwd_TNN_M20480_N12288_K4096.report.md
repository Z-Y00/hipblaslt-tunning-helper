...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1390.02 | 1483.13 | 214.0% | 155.2% |
| **API bench (installed)** | 895.83 | 2301.30 | 137.9% | — |
| **hipblaslt-bench (stock)** | 649.64 | 3173.40 | — | — |

> **Tuned/API ratio (gate metric):** 155.16%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 12288 -n 20480 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,12288,20480,4096,1,4096,50331648,0,4096,83886080,12288,251658240,12288,251658240,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,649645,226.492,3173.4
