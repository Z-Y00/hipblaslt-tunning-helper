...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1390.43 | 13838.50 | 109.0% | 94.5% |
| **API bench (installed)** | 1471.87 | 13072.76 | 115.4% | — |
| **hipblaslt-bench (stock)** | 1275.60 | 15084.30 | — | — |

> **Tuned/API ratio (gate metric):** 94.47%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 20480 -k 57344 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,20480,57344,1,8192,469762048,0,57344,1174405120,8192,167772160,8192,167772160,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.2756e+06,223.743,15084.3
