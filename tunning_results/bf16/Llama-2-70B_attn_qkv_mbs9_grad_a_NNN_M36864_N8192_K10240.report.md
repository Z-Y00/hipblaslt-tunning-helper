...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1420.48 | 4353.98 | 114.4% | 97.8% |
| **API bench (installed)** | 1453.14 | 4256.12 | 117.1% | — |
| **hipblaslt-bench (stock)** | 1241.17 | 4983.00 | — | — |

> **Tuned/API ratio (gate metric):** 97.75%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 36864 -k 10240 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,36864,10240,1,8192,83886080,0,10240,377487360,8192,301989888,8192,301989888,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.24117e+06,285.345,4983
