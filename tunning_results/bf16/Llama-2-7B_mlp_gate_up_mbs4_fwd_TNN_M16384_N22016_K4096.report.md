...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1294.38 | 2282.90 | 110.9% | 97.4% |
| **API bench (installed)** | 1329.44 | 2222.69 | 113.9% | — |
| **hipblaslt-bench (stock)** | 1166.71 | 2532.72 | — | — |

> **Tuned/API ratio (gate metric):** 97.36%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 22016 -n 16384 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,22016,16384,4096,1,4096,90177536,0,4096,67108864,22016,360710144,22016,360710144,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.16671e+06,380.952,2532.72
