...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1417.89 | 781.51 | 124.4% | 100.9% |
| **API bench (installed)** | 1404.58 | 788.92 | 123.2% | — |
| **hipblaslt-bench (stock)** | 1140.02 | 972.00 | — | — |

> **Tuned/API ratio (gate metric):** 100.95%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 12288 -k 11008 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,4096,12288,11008,1,11008,45088768,0,11008,135266304,4096,50331648,4096,50331648,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.14002e+06,442.065,972
