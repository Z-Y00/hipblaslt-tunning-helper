...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1141.26 | 240.85 | 1066.8% | 863.0% |
| **API bench (installed)** | 132.24 | 2078.62 | 123.6% | — |
| **hipblaslt-bench (stock)** | 106.98 | 2569.48 | — | — |

> **Tuned/API ratio (gate metric):** 863.02%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 1024 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 1680 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,1024,8192,1,16384,134217728,0,1024,8388608,16384,16777216,16384,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1680,0,0,106978,115.539,2569.48
