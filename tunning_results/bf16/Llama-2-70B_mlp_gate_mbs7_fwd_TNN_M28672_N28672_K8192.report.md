...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1380.01 | 9760.11 | 110.7% | 96.9% |
| **API bench (installed)** | 1424.44 | 9455.64 | 114.3% | — |
| **hipblaslt-bench (stock)** | 1246.33 | 10806.90 | — | — |

> **Tuned/API ratio (gate metric):** 96.88%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 28672 -n 28672 -k 8192 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,28672,28672,8192,1,8192,234881024,0,8192,234881024,28672,822083584,28672,822083584,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.24633e+06,222.658,10806.9
