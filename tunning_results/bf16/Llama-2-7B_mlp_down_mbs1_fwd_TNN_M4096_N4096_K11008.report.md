...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1361.13 | 271.37 | 204.4% | 168.4% |
| **API bench (installed)** | 808.45 | 456.88 | 121.4% | — |
| **hipblaslt-bench (stock)** | 665.77 | 554.80 | — | — |

> **Tuned/API ratio (gate metric):** 168.36%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 4096 -k 11008 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 1180 --print_kernel_info
```
...
Rotating buffer 1180 MiB. Needed Size: 204 MiB. Needed block count: 6 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,4096,4096,11008,1,11008,45088768,0,11008,45088768,4096,16777216,4096,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1180,0,0,665766,359.082,554.8
