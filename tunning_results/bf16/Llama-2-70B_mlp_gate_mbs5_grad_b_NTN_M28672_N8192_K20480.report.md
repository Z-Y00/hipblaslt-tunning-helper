...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1385.06 | 6946.08 | 115.8% | 101.9% |
| **API bench (installed)** | 1359.80 | 7075.09 | 113.7% | — |
| **hipblaslt-bench (stock)** | 1195.59 | 8046.82 | — | — |

> **Tuned/API ratio (gate metric):** 101.86%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 28672 -k 20480 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,28672,20480,1,8192,167772160,0,28672,587202560,8192,234881024,8192,234881024,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.19559e+06,229.128,8046.82
