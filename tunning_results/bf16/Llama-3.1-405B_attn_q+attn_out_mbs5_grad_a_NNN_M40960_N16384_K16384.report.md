...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1392.47 | 15792.20 | 123.2% | 122.4% |
| **API bench (installed)** | 1137.48 | 19332.45 | 100.7% | — |
| **hipblaslt-bench (stock)** | 1129.99 | 19460.50 | — | — |

> **Tuned/API ratio (gate metric):** 122.42%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 40960 -k 16384 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,16384,40960,16384,1,16384,268435456,0,16384,671088640,16384,671088640,16384,671088640,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.12999e+06,154.158,19460.5
