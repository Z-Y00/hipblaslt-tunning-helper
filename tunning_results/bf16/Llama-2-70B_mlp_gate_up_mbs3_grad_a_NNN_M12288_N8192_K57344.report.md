...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1420.06 | 8129.86 | 114.6% | 100.7% |
| **API bench (installed)** | 1409.72 | 8189.49 | 113.8% | — |
| **hipblaslt-bench (stock)** | 1238.93 | 9318.44 | — | — |

> **Tuned/API ratio (gate metric):** 100.73%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 12288 -k 57344 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,12288,57344,1,8192,469762048,0,57344,704643072,8192,100663296,8192,100663296,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.23893e+06,254.871,9318.44
