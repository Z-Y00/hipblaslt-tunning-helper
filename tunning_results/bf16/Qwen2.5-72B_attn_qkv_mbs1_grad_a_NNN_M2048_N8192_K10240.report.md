...
| **API bench (installed)** | 1231.37 | 279.04 | 111.4% | — |
| **hipblaslt-bench (stock)** | 1105.31 | 310.86 | — | — |
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 2048 -k 10240 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 1650 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
Rotating buffer 1650 MiB. Needed Size: 232 MiB. Needed block count: 8 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,2048,10240,1,8192,83886080,0,10240,20971520,8192,16777216,8192,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1650,1,1,1.10531e+06,728.825,310.86
