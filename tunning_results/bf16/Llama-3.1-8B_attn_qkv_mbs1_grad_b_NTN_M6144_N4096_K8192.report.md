...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1192.77 | 345.68 | 133.6% | 119.7% |
| **API bench (installed)** | 996.82 | 413.63 | 111.7% | — |
| **hipblaslt-bench (stock)** | 892.58 | 461.94 | — | — |

> **Tuned/API ratio (gate metric):** 119.66%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 6144 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 1280 --print_kernel_info
```
...
Rotating buffer 1280 MiB. Needed Size: 208 MiB. Needed block count: 7 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,6144,8192,1,4096,33554432,0,6144,50331648,4096,25165824,4096,25165824,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1280,0,0,892577,439.722,461.94
