...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1426.29 | 10792.40 | 115.3% | 101.6% |
| **API bench (installed)** | 1403.36 | 10968.83 | 113.4% | — |
| **hipblaslt-bench (stock)** | 1237.53 | 12438.60 | — | — |

> **Tuned/API ratio (gate metric):** 101.63%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,8192,32768,28672,1,28672,234881024,0,28672,939524096,8192,268435456,8192,268435456,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.23753e+06,216.061,12438.6
