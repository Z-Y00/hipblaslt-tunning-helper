...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1228.25 | 2349.87 | 128.5% | 116.0% |
| **API bench (installed)** | 1058.46 | 2726.81 | 110.7% | — |
| **hipblaslt-bench (stock)** | 956.09 | 3018.78 | — | — |

> **Tuned/API ratio (gate metric):** 116.04%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 6144 -k 57344 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,6144,57344,1,4096,234881024,0,6144,352321536,4096,25165824,4096,25165824,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,956088,377.843,3018.78
