...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1314.07 | 1124.34 | 116.1% | 103.2% |
| **API bench (installed)** | 1273.90 | 1159.80 | 112.5% | — |
| **hipblaslt-bench (stock)** | 1131.90 | 1305.30 | — | — |

> **Tuned/API ratio (gate metric):** 103.15%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 22016 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,22016,8192,1,4096,33554432,0,22016,180355072,4096,90177536,4096,90177536,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.1319e+06,433.928,1305.3
