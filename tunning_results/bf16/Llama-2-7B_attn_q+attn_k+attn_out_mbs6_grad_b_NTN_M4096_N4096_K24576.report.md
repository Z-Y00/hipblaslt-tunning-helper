...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1417.88 | 581.60 | 114.4% | 100.6% |
| **API bench (installed)** | 1408.77 | 585.36 | 113.7% | — |
| **hipblaslt-bench (stock)** | 1239.08 | 665.52 | — | — |

> **Tuned/API ratio (gate metric):** 100.65%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,4096,24576,1,4096,100663296,0,4096,100663296,4096,16777216,4096,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2240,0,0,1.23908e+06,610.425,665.52
