...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1275.30 | 579.26 | 114.4% | 100.3% |
| **API bench (installed)** | 1271.26 | 581.11 | 114.0% | — |
| **hipblaslt-bench (stock)** | 1114.77 | 662.68 | — | — |

> **Tuned/API ratio (gate metric):** 100.32%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 11008 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 2040 --print_kernel_info
```
...
Rotating buffer 2040 MiB. Needed Size: 322 MiB. Needed block count: 7 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,11008,8192,1,4096,33554432,0,11008,90177536,4096,45088768,4096,45088768,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2040,0,0,1.11477e+06,474.517,662.68
