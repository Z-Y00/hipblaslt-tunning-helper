...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1320.25 | 312.30 | 218.6% | 347.2% |
| **API bench (installed)** | 380.25 | 1084.32 | 63.0% | — |
| **hipblaslt-bench (stock)** | 604.00 | 682.64 | — | — |

> **Tuned/API ratio (gate metric):** 347.20%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 12288 -n 4096 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 1600 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,12288,4096,4096,1,4096,50331648,0,4096,16777216,12288,50331648,12288,50331648,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1600,0,0,604003,320.447,682.64
