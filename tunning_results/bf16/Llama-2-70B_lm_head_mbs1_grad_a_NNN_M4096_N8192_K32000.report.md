...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1194.50 | 1797.81 | 97.5% | 87.0% |
| **API bench (installed)** | 1373.63 | 1563.36 | 112.1% | — |
| **hipblaslt-bench (stock)** | 1225.07 | 1752.94 | — | — |

> **Tuned/API ratio (gate metric):** 86.96%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 4096 -k 32000 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,4096,32000,1,8192,262144000,0,32000,131072000,8192,33554432,8192,33554432,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.22507e+06,453.479,1752.94
