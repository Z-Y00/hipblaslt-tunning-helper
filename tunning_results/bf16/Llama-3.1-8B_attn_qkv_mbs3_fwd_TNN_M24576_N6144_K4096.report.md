...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1421.91 | 869.92 | 114.0% | 98.5% |
| **API bench (installed)** | 1443.19 | 857.10 | 115.7% | — |
| **hipblaslt-bench (stock)** | 1246.90 | 992.02 | — | — |

> **Tuned/API ratio (gate metric):** 98.53%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 6144 -n 24576 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,6144,24576,4096,1,4096,25165824,0,4096,100663296,6144,150994944,6144,150994944,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.2469e+06,519.773,992.02
