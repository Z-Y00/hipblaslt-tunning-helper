...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1164.51 | 73646.30 | 113.2% | 92.4% |
| **API bench (installed)** | 1260.91 | 68015.62 | 122.6% | — |
| **hipblaslt-bench (stock)** | 1028.71 | 83368.20 | — | — |

> **Tuned/API ratio (gate metric):** 92.35%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 53248 -n 16384 -k 49152 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,53248,16384,49152,1,53248,2617245696,0,16384,805306368,53248,872415232,53248,872415232,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.02871e+06,95.9599,83368.2
