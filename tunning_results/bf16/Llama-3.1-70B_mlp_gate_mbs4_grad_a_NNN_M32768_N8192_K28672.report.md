...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1130.32 | 13618.40 | 97.2% | 84.4% |
| **API bench (installed)** | 1339.60 | 11490.86 | 115.3% | — |
| **hipblaslt-bench (stock)** | 1162.33 | 13243.30 | — | — |

> **Tuned/API ratio (gate metric):** 84.38%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 32768 -k 28672 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,32768,28672,1,8192,234881024,0,28672,939524096,8192,268435456,8192,268435456,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.16233e+06,202.932,13243.3
