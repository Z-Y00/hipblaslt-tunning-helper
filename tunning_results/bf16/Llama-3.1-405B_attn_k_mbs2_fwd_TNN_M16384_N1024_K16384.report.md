...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1330.35 | 413.24 | 114.8% | 101.7% |
| **API bench (installed)** | 1308.42 | 420.17 | 112.9% | — |
| **hipblaslt-bench (stock)** | 1158.45 | 474.56 | — | — |

> **Tuned/API ratio (gate metric):** 101.68%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 1024 -n 16384 -k 16384 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,1024,16384,16384,1,16384,16777216,0,16384,268435456,1024,16777216,1024,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.15845e+06,1185.31,474.56
