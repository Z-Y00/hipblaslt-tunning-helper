...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1313.17 | 11722.10 | 114.1% | 98.0% |
| **API bench (installed)** | 1340.56 | 11482.63 | 116.5% | — |
| **hipblaslt-bench (stock)** | 1150.97 | 13374.10 | — | — |

> **Tuned/API ratio (gate metric):** 97.96%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 28672 -n 8192 -k 32768 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,28672,8192,32768,1,28672,939524096,0,8192,268435456,28672,234881024,28672,234881024,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.15097e+06,200.948,13374.1
