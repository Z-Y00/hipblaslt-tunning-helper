...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1143.92 | 938.65 | 98.9% | 90.9% |
| **API bench (installed)** | 1257.92 | 853.58 | 108.7% | — |
| **hipblaslt-bench (stock)** | 1157.19 | 927.89 | — | — |

> **Tuned/API ratio (gate metric):** 90.94%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 32000 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,32000,4096,1,4096,16777216,0,32000,131072000,4096,131072000,4096,131072000,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.15719e+06,559.906,927.89
