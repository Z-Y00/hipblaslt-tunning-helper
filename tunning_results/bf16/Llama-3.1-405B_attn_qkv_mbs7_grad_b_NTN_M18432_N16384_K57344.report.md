...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1359.94 | 25467.70 | 110.6% | 97.8% |
| **API bench (installed)** | 1391.01 | 24898.87 | 113.2% | — |
| **hipblaslt-bench (stock)** | 1229.35 | 28173.20 | — | — |

> **Tuned/API ratio (gate metric):** 97.77%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 18432 -k 57344 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,18432,57344,1,16384,939524096,0,18432,1056964608,16384,301989888,16384,301989888,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.22935e+06,151.962,28173.2
