# Llama-3.1-8B — mlp_gate_up [grad_b]
...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1330.21 | 13018.40 | 117.3% | 99.9% |
| **API bench (installed)** | 1332.12 | 12999.79 | 117.5% | — |
| **hipblaslt-bench (stock)** | 1134.19 | 15268.40 | — | — |

> **Tuned/API ratio (gate metric):** 99.86%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 28672 -k 73728 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,28672,73728,1,4096,301989888,0,28672,2113929216,4096,117440512,4096,117440512,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.13419e+06,309.053,15268.4
