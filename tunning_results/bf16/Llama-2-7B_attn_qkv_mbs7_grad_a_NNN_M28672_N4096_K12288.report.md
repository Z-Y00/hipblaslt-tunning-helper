...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1347.36 | 2142.12 | 135.5% | 125.7% |
| **API bench (installed)** | 1071.58 | 2693.42 | 107.8% | — |
| **hipblaslt-bench (stock)** | 994.47 | 2902.26 | — | — |

> **Tuned/API ratio (gate metric):** 125.74%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 28672 -k 12288 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,28672,12288,1,4096,50331648,0,12288,352321536,4096,117440512,4096,117440512,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,994473,333.792,2902.26
