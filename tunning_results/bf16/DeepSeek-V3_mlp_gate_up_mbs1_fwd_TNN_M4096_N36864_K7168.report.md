...
| **API bench (installed)** | 1454.14 | 1488.63 | 114.6% | — |
| **hipblaslt-bench (stock)** | 1268.66 | 1706.26 | — | — |
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 36864 -n 4096 -k 7168 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,36864,4096,7168,1,7168,264241152,0,7168,29360128,36864,150994944,36864,150994944,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.26866e+06,485.345,1706.26
