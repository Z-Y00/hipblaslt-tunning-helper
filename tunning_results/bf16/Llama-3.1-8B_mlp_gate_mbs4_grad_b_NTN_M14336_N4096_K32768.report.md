...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1322.78 | 2909.25 | 115.7% | 101.3% |
| **API bench (installed)** | 1305.27 | 2948.27 | 114.1% | — |
| **hipblaslt-bench (stock)** | 1143.75 | 3364.62 | — | — |

> **Tuned/API ratio (gate metric):** 101.34%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 14336 -k 32768 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,14336,32768,1,4096,134217728,0,14336,469762048,4096,58720256,4096,58720256,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.14375e+06,366.869,3364.62
