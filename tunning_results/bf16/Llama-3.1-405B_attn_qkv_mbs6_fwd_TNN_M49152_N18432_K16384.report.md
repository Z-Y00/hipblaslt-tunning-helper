...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1102.92 | 26916.50 | 88.5% | 75.7% |
| **API bench (installed)** | 1456.39 | 20383.78 | 116.8% | — |
| **hipblaslt-bench (stock)** | 1246.75 | 23811.40 | — | — |

> **Tuned/API ratio (gate metric):** 75.73%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 18432 -n 49152 -k 16384 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,18432,49152,16384,1,16384,301989888,0,16384,805306368,18432,905969664,18432,905969664,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.24675e+06,157.488,23811.4
