...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1365.19 | 21745.60 | 112.4% | 100.5% |
| **API bench (installed)** | 1358.91 | 21846.09 | 111.8% | — |
| **hipblaslt-bench (stock)** | 1215.09 | 24431.90 | — | — |

> **Tuned/API ratio (gate metric):** 100.46%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 49152 -k 18432 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,16384,49152,18432,1,16384,301989888,0,18432,905969664,16384,805306368,16384,805306368,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.21509e+06,153.488,24431.9
