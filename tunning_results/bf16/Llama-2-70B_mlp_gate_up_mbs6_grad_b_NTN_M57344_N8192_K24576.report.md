...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1320.20 | 17489.60 | 122.8% | 107.6% |
| **API bench (installed)** | 1227.38 | 18812.22 | 114.2% | — |
| **hipblaslt-bench (stock)** | 1074.68 | 21485.30 | — | — |

> **Tuned/API ratio (gate metric):** 107.56%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 57344 -k 24576 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,57344,24576,1,8192,201326592,0,57344,1409286144,8192,469762048,8192,469762048,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.07468e+06,180.356,21485.3
