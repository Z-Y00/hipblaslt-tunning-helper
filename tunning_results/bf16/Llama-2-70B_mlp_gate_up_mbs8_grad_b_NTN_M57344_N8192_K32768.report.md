...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1314.16 | 23426.70 | 110.4% | 96.5% |
| **API bench (installed)** | 1361.64 | 22609.71 | 114.3% | — |
| **hipblaslt-bench (stock)** | 1190.77 | 25854.20 | — | — |

> **Tuned/API ratio (gate metric):** 96.51%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,57344,32768,1,8192,268435456,0,57344,1879048192,8192,469762048,8192,469762048,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.19077e+06,188.557,25854.2
