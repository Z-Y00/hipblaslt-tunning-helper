...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1285.30 | 574.75 | 119.8% | 103.9% |
| **API bench (installed)** | 1236.70 | 597.34 | 115.3% | — |
| **hipblaslt-bench (stock)** | 1072.74 | 688.64 | — | — |

> **Tuned/API ratio (gate metric):** 103.93%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 11008 -n 4096 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 2040 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,11008,4096,8192,1,11008,90177536,0,4096,33554432,11008,45088768,11008,45088768,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2040,0,0,1.07274e+06,456.629,688.64
