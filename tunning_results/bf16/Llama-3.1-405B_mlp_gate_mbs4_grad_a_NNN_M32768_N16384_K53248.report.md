...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1363.01 | 41947.30 | 113.0% | 99.0% |
| **API bench (installed)** | 1376.91 | 41523.86 | 114.2% | — |
| **hipblaslt-bench (stock)** | 1206.04 | 47406.70 | — | — |

> **Tuned/API ratio (gate metric):** 98.99%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 32768 -k 53248 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,16384,32768,53248,1,16384,872415232,0,53248,1744830464,16384,536870912,16384,536870912,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.20604e+06,123.928,47406.7
