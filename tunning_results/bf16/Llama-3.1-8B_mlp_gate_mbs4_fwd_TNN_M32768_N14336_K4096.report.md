...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1337.66 | 2876.89 | 111.3% | 95.2% |
| **API bench (installed)** | 1405.58 | 2737.87 | 116.9% | — |
| **hipblaslt-bench (stock)** | 1202.36 | 3200.62 | — | — |

> **Tuned/API ratio (gate metric):** 95.17%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 14336 -n 32768 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,14336,32768,4096,1,4096,58720256,0,4096,134217728,14336,469762048,14336,469762048,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.20236e+06,385.667,3200.62
