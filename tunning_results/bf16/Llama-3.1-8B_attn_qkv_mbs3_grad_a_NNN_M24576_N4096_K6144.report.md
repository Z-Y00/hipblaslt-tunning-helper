...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1411.04 | 876.63 | 116.1% | 99.9% |
| **API bench (installed)** | 1412.05 | 876.00 | 116.2% | — |
| **hipblaslt-bench (stock)** | 1215.49 | 1017.66 | — | — |

> **Tuned/API ratio (gate metric):** 99.93%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 24576 -k 6144 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,24576,6144,1,4096,25165824,0,6144,150994944,4096,100663296,4096,100663296,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.21549e+06,506.677,1017.66
