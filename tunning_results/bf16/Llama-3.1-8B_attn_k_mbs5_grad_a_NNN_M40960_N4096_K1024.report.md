...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1021.41 | 336.39 | 104.8% | 94.5% |
| **API bench (installed)** | 1081.13 | 317.81 | 111.0% | — |
| **hipblaslt-bench (stock)** | 974.25 | 352.68 | — | — |

> **Tuned/API ratio (gate metric):** 94.48%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 40960 -k 1024 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,40960,1024,1,4096,4194304,0,1024,41943040,4096,167772160,4096,167772160,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,974247,1129.74,352.68
