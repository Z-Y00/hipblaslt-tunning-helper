...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1408.40 | 4781.66 | 111.3% | 99.3% |
| **API bench (installed)** | 1418.66 | 4747.10 | 112.1% | — |
| **hipblaslt-bench (stock)** | 1265.18 | 5322.96 | — | — |

> **Tuned/API ratio (gate metric):** 99.28%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 14336 -n 57344 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,14336,57344,4096,1,4096,58720256,0,4096,234881024,14336,822083584,14336,822083584,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.26518e+06,390.408,5322.96
