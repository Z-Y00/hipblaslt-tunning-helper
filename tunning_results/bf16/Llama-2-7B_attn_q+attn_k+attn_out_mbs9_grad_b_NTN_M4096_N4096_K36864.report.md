...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1430.13 | 864.92 | 115.1% | 101.9% |
| **API bench (installed)** | 1402.79 | 881.78 | 112.9% | — |
| **hipblaslt-bench (stock)** | 1242.59 | 995.46 | — | — |

> **Tuned/API ratio (gate metric):** 101.95%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 4096 -k 36864 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,4096,36864,1,4096,150994944,0,4096,150994944,4096,16777216,4096,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.24259e+06,596.458,995.46
