...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1295.77 | 2545.61 | 132.8% | 119.9% |
| **API bench (installed)** | 1080.39 | 3053.11 | 110.7% | — |
| **hipblaslt-bench (stock)** | 975.99 | 3379.68 | — | — |

> **Tuned/API ratio (gate metric):** 119.94%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 6144 -k 65536 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,6144,65536,1,4096,268435456,0,6144,402653184,4096,25165824,4096,25165824,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,975990,383.727,3379.68
