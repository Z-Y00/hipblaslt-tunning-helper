...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1425.86 | 5397.84 | 110.1% | 96.8% |
| **API bench (installed)** | 1473.03 | 5224.99 | 113.7% | — |
| **hipblaslt-bench (stock)** | 1295.12 | 5942.74 | — | — |

> **Tuned/API ratio (gate metric):** 96.80%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,28672,16384,8192,1,8192,234881024,0,8192,134217728,28672,469762048,28672,469762048,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.29512e+06,262.926,5942.74
