...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 833.91 | 23733.10 | 482.3% | 374.6% |
| **API bench (installed)** | 222.62 | 88901.90 | 128.7% | — |
| **hipblaslt-bench (stock)** | 172.91 | 114460.00 | — | — |

> **Tuned/API ratio (gate metric):** 374.59%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 18432 -n 32768 -k 16384 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,18432,32768,16384,1,16384,301989888,0,16384,536870912,18432,603979776,18432,603979776,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,172909,23.4797,114460
