...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1377.05 | 998.07 | 115.2% | 113.5% |
| **API bench (installed)** | 1213.70 | 1132.39 | 101.5% | — |
| **hipblaslt-bench (stock)** | 1195.72 | 1149.42 | — | — |

> **Tuned/API ratio (gate metric):** 113.46%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 40960 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,40960,4096,1,4096,16777216,0,4096,167772160,4096,167772160,4096,167772160,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.19572e+06,570.94,1149.42
