...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1404.20 | 3915.09 | 112.9% | 97.6% |
| **API bench (installed)** | 1438.82 | 3820.89 | 115.7% | — |
| **hipblaslt-bench (stock)** | 1243.22 | 4422.04 | — | — |

> **Tuned/API ratio (gate metric):** 97.59%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,32768,10240,1,8192,83886080,0,10240,335544320,8192,268435456,8192,268435456,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.24322e+06,289.742,4422.04
