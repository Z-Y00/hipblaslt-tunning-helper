...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1375.90 | 299.67 | 113.9% | 97.9% |
| **API bench (installed)** | 1405.12 | 293.44 | 116.3% | — |
| **hipblaslt-bench (stock)** | 1207.87 | 341.36 | — | — |

> **Tuned/API ratio (gate metric):** 97.92%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 12288 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 1600 --print_kernel_info
```
...
Rotating buffer 1600 MiB. Needed Size: 224 MiB. Needed block count: 8 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,4096,12288,4096,1,4096,16777216,0,4096,50331648,4096,50331648,4096,50331648,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1600,0,0,1.20787e+06,640.819,341.36
