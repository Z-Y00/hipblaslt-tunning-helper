...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1360.59 | 2121.30 | 110.4% | 99.5% |
| **API bench (installed)** | 1367.72 | 2110.24 | 111.0% | — |
| **hipblaslt-bench (stock)** | 1231.93 | 2342.84 | — | — |

> **Tuned/API ratio (gate metric):** 99.48%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 12288 -k 28672 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,12288,28672,1,4096,117440512,0,12288,352321536,4096,50331648,4096,50331648,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.23193e+06,413.494,2342.84
