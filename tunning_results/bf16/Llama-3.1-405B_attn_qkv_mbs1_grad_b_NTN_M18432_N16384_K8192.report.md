...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1355.09 | 3651.26 | 112.8% | 97.2% |
| **API bench (installed)** | 1393.55 | 3550.51 | 116.0% | — |
| **hipblaslt-bench (stock)** | 1201.41 | 4118.32 | — | — |

> **Tuned/API ratio (gate metric):** 97.24%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 18432 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,18432,8192,1,16384,134217728,0,18432,150994944,16384,301989888,16384,301989888,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.20141e+06,265.582,4118.32
