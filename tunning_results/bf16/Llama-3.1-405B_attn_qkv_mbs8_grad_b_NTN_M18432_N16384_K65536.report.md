...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1247.67 | 31725.20 | 115.0% | 98.3% |
| **API bench (installed)** | 1269.47 | 31180.32 | 117.0% | — |
| **hipblaslt-bench (stock)** | 1085.30 | 36471.40 | — | — |

> **Tuned/API ratio (gate metric):** 98.28%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 18432 -k 65536 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,18432,65536,1,16384,1073741824,0,18432,1207959552,16384,301989888,16384,301989888,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.0853e+06,131.953,36471.4
