...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1240.14 | 3103.10 | 100.6% | 88.2% |
| **API bench (installed)** | 1405.99 | 2737.07 | 114.1% | — |
| **hipblaslt-bench (stock)** | 1232.30 | 3122.85 | — | — |

> **Tuned/API ratio (gate metric):** 88.20%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 57344 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,57344,4096,1,8192,33554432,0,57344,234881024,8192,469762048,8192,469762048,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.2323e+06,440.302,3122.85
