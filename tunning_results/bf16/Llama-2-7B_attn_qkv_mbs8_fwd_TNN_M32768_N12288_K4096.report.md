...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1449.67 | 2275.36 | 279.5% | 319.2% |
| **API bench (installed)** | 454.12 | 7263.52 | 87.6% | — |
| **hipblaslt-bench (stock)** | 518.62 | 6360.18 | — | — |

> **Tuned/API ratio (gate metric):** 319.22%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 12288 -n 32768 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,12288,32768,4096,1,4096,50331648,0,4096,134217728,12288,402653184,12288,402653184,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,518623,171.968,6360.18
