...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1333.18 | 2474.18 | 112.2% | 99.4% |
| **API bench (installed)** | 1340.78 | 2460.17 | 112.8% | — |
| **hipblaslt-bench (stock)** | 1188.34 | 2775.74 | — | — |

> **Tuned/API ratio (gate metric):** 99.43%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 12288 -k 32768 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,12288,32768,1,4096,134217728,0,12288,402653184,4096,50331648,4096,50331648,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.18834e+06,394.039,2775.74
