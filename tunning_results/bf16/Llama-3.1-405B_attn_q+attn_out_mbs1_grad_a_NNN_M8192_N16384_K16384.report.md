...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1407.32 | 3125.13 | 156.3% | 193.6% |
| **API bench (installed)** | 726.89 | 6050.53 | 80.8% | — |
| **hipblaslt-bench (stock)** | 900.16 | 4885.86 | — | — |

> **Tuned/API ratio (gate metric):** 193.61%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 8192 -k 16384 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,16384,8192,16384,1,16384,268435456,0,16384,134217728,16384,134217728,16384,134217728,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,900158,204.672,4885.86
