...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1361.25 | 1413.51 | 266.6% | 428.5% |
| **API bench (installed)** | 317.70 | 6056.51 | 62.2% | — |
| **hipblaslt-bench (stock)** | 510.58 | 3768.56 | — | — |

> **Tuned/API ratio (gate metric):** 428.47%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 16384 -k 14336 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,16384,14336,1,4096,58720256,0,14336,234881024,4096,67108864,4096,67108864,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,510578,178.284,3768.56
