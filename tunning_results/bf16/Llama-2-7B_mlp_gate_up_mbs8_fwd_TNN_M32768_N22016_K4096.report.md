...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1342.32 | 4402.74 | 110.3% | 97.6% |
| **API bench (installed)** | 1375.67 | 4296.01 | 113.1% | — |
| **hipblaslt-bench (stock)** | 1216.58 | 4857.78 | — | — |

> **Tuned/API ratio (gate metric):** 97.58%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 22016 -n 32768 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,22016,32768,4096,1,4096,90177536,0,4096,134217728,22016,721420288,22016,721420288,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.21658e+06,362.659,4857.78
