...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1338.44 | 7188.01 | 115.2% | 104.2% |
| **API bench (installed)** | 1284.04 | 7492.56 | 110.5% | — |
| **hipblaslt-bench (stock)** | 1162.19 | 8278.12 | — | — |

> **Tuned/API ratio (gate metric):** 104.24%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 28672 -n 20480 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,28672,20480,8192,1,28672,234881024,0,8192,167772160,28672,587202560,28672,587202560,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.16219e+06,222.726,8278.12
