...
| **API bench (installed)** | 1280.63 | 1341.52 | 111.5% | — |
| **hipblaslt-bench (stock)** | 1148.35 | 1496.04 | — | — |
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 102400 -n 4096 -k 2048 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,102400,4096,2048,1,2048,209715200,0,2048,8388608,102400,419430400,102400,419430400,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.14835e+06,793.761,1496.04
