...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1407.61 | 1757.52 | 140.0% | 186.0% |
| **API bench (installed)** | 756.86 | 3268.65 | 75.3% | — |
| **hipblaslt-bench (stock)** | 1005.45 | 2460.50 | — | — |

> **Tuned/API ratio (gate metric):** 185.98%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 24576 -k 12288 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,24576,12288,1,4096,50331648,0,12288,301989888,4096,100663296,4096,100663296,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.00545e+06,342.918,2460.5
