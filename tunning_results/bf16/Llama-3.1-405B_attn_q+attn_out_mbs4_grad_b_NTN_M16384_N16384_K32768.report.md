...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1351.50 | 13016.80 | 113.6% | 98.6% |
| **API bench (installed)** | 1371.19 | 12829.83 | 115.3% | — |
| **hipblaslt-bench (stock)** | 1189.60 | 14788.40 | — | — |

> **Tuned/API ratio (gate metric):** 98.56%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 16384 -k 32768 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,16384,32768,1,16384,536870912,0,16384,536870912,16384,268435456,16384,268435456,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.1896e+06,169.052,14788.4
