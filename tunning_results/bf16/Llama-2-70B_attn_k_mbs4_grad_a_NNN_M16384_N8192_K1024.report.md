...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 987.84 | 278.26 | 105.1% | 3066.7% |
| **API bench (installed)** | 32.21 | 8533.48 | 3.4% | — |
| **hipblaslt-bench (stock)** | 940.33 | 292.32 | — | — |

> **Tuned/API ratio (gate metric):** 3066.70%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,16384,1024,1,8192,8388608,0,1024,16777216,8192,134217728,8192,134217728,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,940332,1015.58,292.32
