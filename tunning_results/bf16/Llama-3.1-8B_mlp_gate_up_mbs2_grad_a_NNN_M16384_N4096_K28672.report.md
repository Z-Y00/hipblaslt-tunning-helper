...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1439.90 | 2672.60 | 140.9% | 120.9% |
| **API bench (installed)** | 1191.42 | 3230.00 | 116.6% | — |
| **hipblaslt-bench (stock)** | 1021.72 | 3766.50 | — | — |

> **Tuned/API ratio (gate metric):** 120.86%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 16384 -k 28672 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,16384,28672,1,4096,117440512,0,28672,469762048,4096,67108864,4096,67108864,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.02172e+06,323.576,3766.5
