...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1346.15 | 21236.40 | 117.4% | 95.2% |
| **API bench (installed)** | 1413.42 | 20225.67 | 123.3% | — |
| **hipblaslt-bench (stock)** | 1146.36 | 24937.50 | — | — |

> **Tuned/API ratio (gate metric):** 95.24%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 106496 -n 8192 -k 16384 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,106496,8192,16384,1,16384,1744830464,0,16384,134217728,106496,872415232,106496,872415232,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.14636e+06,205.514,24937.5
