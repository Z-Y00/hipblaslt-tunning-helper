...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1405.85 | 10558.30 | 111.4% | 100.4% |
| **API bench (installed)** | 1400.79 | 10596.48 | 111.0% | — |
| **hipblaslt-bench (stock)** | 1261.96 | 11762.20 | — | — |

> **Tuned/API ratio (gate metric):** 100.36%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 18432 -k 24576 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,18432,24576,1,16384,402653184,0,18432,452984832,16384,301989888,16384,301989888,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.26196e+06,183.32,11762.2
