...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1364.97 | 1082.42 | 115.9% | 99.5% |
| **API bench (installed)** | 1371.97 | 1076.90 | 116.5% | — |
| **hipblaslt-bench (stock)** | 1177.51 | 1254.74 | — | — |

> **Tuned/API ratio (gate metric):** 99.49%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 11008 -k 16384 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,11008,16384,1,4096,67108864,0,11008,180355072,4096,45088768,4096,45088768,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.17751e+06,434.291,1254.74
