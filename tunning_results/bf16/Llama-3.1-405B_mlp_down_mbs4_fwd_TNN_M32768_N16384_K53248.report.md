...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1372.75 | 41649.60 | 113.3% | 97.5% |
| **API bench (installed)** | 1408.42 | 40594.85 | 116.2% | — |
| **hipblaslt-bench (stock)** | 1211.89 | 47178.20 | — | — |

> **Tuned/API ratio (gate metric):** 97.47%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 32768 -k 53248 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,16384,32768,53248,1,53248,872415232,0,53248,1744830464,16384,536870912,16384,536870912,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.21189e+06,124.528,47178.2
