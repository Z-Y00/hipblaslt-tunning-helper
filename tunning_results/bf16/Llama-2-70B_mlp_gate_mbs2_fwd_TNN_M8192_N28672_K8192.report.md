...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1396.73 | 2755.21 | 111.0% | 96.6% |
| **API bench (installed)** | 1445.34 | 2662.55 | 114.9% | — |
| **hipblaslt-bench (stock)** | 1257.87 | 3059.36 | — | — |

> **Tuned/API ratio (gate metric):** 96.64%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,28672,8192,8192,1,8192,234881024,0,8192,67108864,28672,234881024,28672,234881024,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.25787e+06,326.866,3059.36
