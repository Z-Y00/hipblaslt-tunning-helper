...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1315.41 | 1253.81 | 194.3% | 272.3% |
| **API bench (installed)** | 483.04 | 3414.33 | 71.3% | — |
| **hipblaslt-bench (stock)** | 677.06 | 2435.94 | — | — |

> **Tuned/API ratio (gate metric):** 272.32%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 1024 -n 49152 -k 16384 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,1024,49152,16384,1,16384,16777216,0,16384,805306368,1024,50331648,1024,50331648,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,677056,667.094,2435.94
