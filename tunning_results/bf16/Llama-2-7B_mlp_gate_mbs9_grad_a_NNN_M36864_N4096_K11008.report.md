...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1369.46 | 2427.45 | 112.2% | 99.1% |
| **API bench (installed)** | 1381.47 | 2406.35 | 113.1% | — |
| **hipblaslt-bench (stock)** | 1221.04 | 2722.52 | — | — |

> **Tuned/API ratio (gate metric):** 99.13%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 36864 -k 11008 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,36864,11008,1,4096,45088768,0,11008,405798912,4096,150994944,4096,150994944,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.22104e+06,411.785,2722.52
