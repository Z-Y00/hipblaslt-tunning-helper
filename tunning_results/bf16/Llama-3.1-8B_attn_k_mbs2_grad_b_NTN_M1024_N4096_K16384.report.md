...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 990.85 | 138.71 | 143.6% | 129.5% |
| **API bench (installed)** | 765.19 | 179.61 | 110.9% | — |
| **hipblaslt-bench (stock)** | 690.09 | 199.16 | — | — |

> **Tuned/API ratio (gate metric):** 129.49%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 1024 -k 16384 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 880 --print_kernel_info
```
...
Rotating buffer 880 MiB. Needed Size: 168 MiB. Needed block count: 6 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,1024,16384,1,4096,67108864,0,1024,16777216,4096,4194304,4096,4194304,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,880,0,0,690093,823.772,199.16
