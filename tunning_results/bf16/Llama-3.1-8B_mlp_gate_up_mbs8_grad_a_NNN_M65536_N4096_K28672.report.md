# Llama-3.1-8B — mlp_gate_up [grad_a]
...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1456.58 | 10568.00 | 126.7% | 144.1% |
| **API bench (installed)** | 1011.12 | 15223.92 | 88.0% | — |
| **hipblaslt-bench (stock)** | 1149.54 | 13390.70 | — | — |

> **Tuned/API ratio (gate metric):** 144.06%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 65536 -k 28672 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,65536,28672,1,4096,117440512,0,28672,1879048192,4096,268435456,4096,268435456,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.14954e+06,315.05,13390.7
