...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1409.52 | 24572.00 | 114.0% | 101.4% |
| **API bench (installed)** | 1390.30 | 24911.67 | 112.4% | — |
| **hipblaslt-bench (stock)** | 1236.65 | 28006.80 | — | — |

> **Tuned/API ratio (gate metric):** 101.38%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 57344 -k 18432 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,16384,57344,18432,1,16384,301989888,0,18432,1056964608,16384,939524096,16384,939524096,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.23665e+06,152.865,28006.8
