...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1327.36 | 2226.18 | 116.9% | 101.9% |
| **API bench (installed)** | 1302.57 | 2268.54 | 114.7% | — |
| **hipblaslt-bench (stock)** | 1135.24 | 2602.92 | — | — |

> **Tuned/API ratio (gate metric):** 101.90%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 11008 -k 32768 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,11008,32768,1,4096,134217728,0,11008,360710144,4096,45088768,4096,45088768,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.13524e+06,386.435,2602.92
