...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1347.62 | 3289.07 | 150.6% | 137.3% |
| **API bench (installed)** | 981.37 | 4516.54 | 109.6% | — |
| **hipblaslt-bench (stock)** | 895.01 | 4952.34 | — | — |

> **Tuned/API ratio (gate metric):** 137.32%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 22016 -n 24576 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,22016,24576,4096,1,4096,90177536,0,4096,100663296,22016,541065216,22016,541065216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,895013,275.28,4952.34
