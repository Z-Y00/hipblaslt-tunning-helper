...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1351.53 | 7118.38 | 116.8% | 100.8% |
| **API bench (installed)** | 1341.22 | 7173.11 | 115.9% | — |
| **hipblaslt-bench (stock)** | 1157.59 | 8311.02 | — | — |

> **Tuned/API ratio (gate metric):** 100.77%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 28672 -k 40960 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,28672,40960,1,4096,167772160,0,28672,1174405120,4096,117440512,4096,117440512,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.15759e+06,327.126,8311.02
