...
| **API bench (installed)** | 987.92 | 185.86 | 110.9% | — |
| **hipblaslt-bench (stock)** | 890.49 | 206.19 | — | — |
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 10944 -n 4096 -k 2048 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 1436 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
Rotating buffer 1436 MiB. Needed Size: 144 MiB. Needed block count: 10 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,10944,4096,2048,1,2048,22413312,0,2048,8388608,10944,44826624,10944,44826624,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1436,1,1,890492,683.203,206.189
