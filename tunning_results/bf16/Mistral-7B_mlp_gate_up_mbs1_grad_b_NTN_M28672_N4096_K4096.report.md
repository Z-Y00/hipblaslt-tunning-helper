...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1214.54 | 792.13 | 100.3% | 88.3% |
| **API bench (installed)** | 1375.46 | 699.46 | 113.5% | — |
| **hipblaslt-bench (stock)** | 1211.41 | 794.17 | — | — |

> **Tuned/API ratio (gate metric):** 88.30%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 28672 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,28672,4096,1,4096,16777216,0,28672,117440512,4096,117440512,4096,117440512,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.21141e+06,590.236,794.174
