...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1439.95 | 1145.36 | 184.1% | 159.7% |
| **API bench (installed)** | 901.85 | 1828.76 | 115.3% | — |
| **hipblaslt-bench (stock)** | 782.21 | 2108.48 | — | — |

> **Tuned/API ratio (gate metric):** 159.67%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 16384 -k 12288 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,16384,12288,1,4096,50331648,0,12288,201326592,4096,67108864,4096,67108864,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,782207,281.601,2108.48
