...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1307.02 | 20189.70 | 117.0% | 98.3% |
| **API bench (installed)** | 1330.02 | 19840.47 | 119.0% | — |
| **hipblaslt-bench (stock)** | 1117.25 | 23619.00 | — | — |

> **Tuned/API ratio (gate metric):** 98.27%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 16384 -k 49152 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,16384,49152,1,16384,805306368,0,16384,805306368,16384,268435456,16384,268435456,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.11725e+06,148.186,23619
