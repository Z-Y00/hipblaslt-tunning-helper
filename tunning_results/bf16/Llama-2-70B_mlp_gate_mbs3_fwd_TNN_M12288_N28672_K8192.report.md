...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1386.84 | 4162.31 | 111.8% | 97.3% |
| **API bench (installed)** | 1424.67 | 4051.76 | 114.8% | — |
| **hipblaslt-bench (stock)** | 1240.87 | 4651.92 | — | — |

> **Tuned/API ratio (gate metric):** 97.34%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 28672 -n 12288 -k 8192 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,28672,12288,8192,1,8192,234881024,0,8192,100663296,28672,352321536,28672,352321536,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.24087e+06,275.424,4651.92
