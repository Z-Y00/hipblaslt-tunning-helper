...
| **API bench (installed)** | 604.88 | 610.64 | 106.3% | — |
| **hipblaslt-bench (stock)** | 568.98 | 649.18 | — | — |
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 11008 -n 4096 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 1450 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,11008,4096,4096,1,11008,45088768,0,4096,16777216,11008,45088768,11008,45088768,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1450,0,0,568975,306.878,649.18
