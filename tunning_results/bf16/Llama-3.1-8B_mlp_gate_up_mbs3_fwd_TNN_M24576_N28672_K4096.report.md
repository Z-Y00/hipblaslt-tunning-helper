...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1334.11 | 4326.80 | 109.8% | 107.8% |
| **API bench (installed)** | 1237.58 | 4664.31 | 101.8% | — |
| **hipblaslt-bench (stock)** | 1215.21 | 4750.14 | — | — |

> **Tuned/API ratio (gate metric):** 107.80%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 28672 -n 24576 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,28672,24576,4096,1,4096,117440512,0,4096,100663296,28672,704643072,28672,704643072,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.21521e+06,361.831,4750.14
