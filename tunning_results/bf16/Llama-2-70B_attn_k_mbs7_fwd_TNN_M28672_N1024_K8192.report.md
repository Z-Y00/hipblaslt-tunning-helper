...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1355.00 | 355.01 | 118.1% | 106.5% |
| **API bench (installed)** | 1271.83 | 378.22 | 110.9% | — |
| **hipblaslt-bench (stock)** | 1147.07 | 419.36 | — | — |

> **Tuned/API ratio (gate metric):** 106.54%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 1024 -n 28672 -k 8192 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,1024,28672,8192,1,8192,8388608,0,8192,234881024,1024,29360128,1024,29360128,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.14707e+06,1210.92,419.36
