...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1435.10 | 1149.23 | 113.1% | 98.2% |
| **API bench (installed)** | 1461.15 | 1128.75 | 115.2% | — |
| **hipblaslt-bench (stock)** | 1268.61 | 1300.06 | — | — |

> **Tuned/API ratio (gate metric):** 98.22%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 4096 -k 49152 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,4096,49152,1,4096,201326592,0,4096,201326592,4096,16777216,4096,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.26861e+06,600.934,1300.06
