...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1363.08 | 9679.65 | 109.7% | 97.3% |
| **API bench (installed)** | 1401.28 | 9415.77 | 112.8% | — |
| **hipblaslt-bench (stock)** | 1242.73 | 10617.00 | — | — |

> **Tuned/API ratio (gate metric):** 97.27%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 24576 -k 16384 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,16384,24576,16384,1,16384,268435456,0,16384,402653184,16384,402653184,16384,402653184,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.24273e+06,188.377,10617
