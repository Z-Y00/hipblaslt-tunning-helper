...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1079.75 | 4105.01 | 118.5% | 94.0% |
| **API bench (installed)** | 1148.74 | 3858.48 | 126.0% | — |
| **hipblaslt-bench (stock)** | 911.35 | 4863.58 | — | — |

> **Tuned/API ratio (gate metric):** 93.99%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 22016 -k 24576 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,22016,24576,1,4096,100663296,0,22016,541065216,4096,90177536,4096,90177536,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,911346,280.304,4863.58
