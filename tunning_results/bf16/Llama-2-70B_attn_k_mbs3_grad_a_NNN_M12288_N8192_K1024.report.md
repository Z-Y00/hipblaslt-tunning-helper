...
| **API bench (installed)** | 164.59 | 1252.59 | 115.7% | — |
| **hipblaslt-bench (stock)** | 142.24 | 1449.36 | — | — |
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 12288 -k 1024 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 2120 --print_kernel_info
```
...
Rotating buffer 2120 MiB. Needed Size: 232 MiB. Needed block count: 1 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,12288,1024,1,8192,8388608,0,1024,12582912,8192,100663296,8192,100663296,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2120,0,0,142241,156.319,1449.36
