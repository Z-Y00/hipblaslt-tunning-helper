...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1243.83 | 1988.93 | 129.7% | 116.7% |
| **API bench (installed)** | 1065.57 | 2321.66 | 111.1% | — |
| **hipblaslt-bench (stock)** | 958.85 | 2580.06 | — | — |

> **Tuned/API ratio (gate metric):** 116.73%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 6144 -k 49152 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,6144,49152,1,4096,201326592,0,6144,301989888,4096,25165824,4096,25165824,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,958854,381.532,2580.06
