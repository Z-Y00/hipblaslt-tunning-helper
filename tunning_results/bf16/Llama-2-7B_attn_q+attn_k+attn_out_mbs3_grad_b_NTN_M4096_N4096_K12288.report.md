...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1311.79 | 314.31 | 115.3% | 97.5% |
| **API bench (installed)** | 1345.67 | 306.40 | 118.3% | — |
| **hipblaslt-bench (stock)** | 1137.68 | 362.42 | — | — |

> **Tuned/API ratio (gate metric):** 97.48%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 4096 -k 12288 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 1280 --print_kernel_info
```
...
Rotating buffer 1280 MiB. Needed Size: 224 MiB. Needed block count: 6 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,4096,12288,1,4096,50331648,0,4096,50331648,4096,16777216,4096,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1280,0,0,1.13768e+06,603.581,362.42
