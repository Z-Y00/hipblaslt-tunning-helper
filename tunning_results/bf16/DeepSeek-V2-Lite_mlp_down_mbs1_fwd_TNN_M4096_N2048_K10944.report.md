...
| **API bench (installed)** | 747.28 | 245.71 | 103.9% | — |
| **hipblaslt-bench (stock)** | 719.37 | 255.24 | — | — |
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 2048 -n 4096 -k 10944 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 1002 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,2048,4096,10944,1,10944,22413312,0,10944,44826624,2048,8388608,2048,8388608,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1002,1,1,719368,551.913,255.238
