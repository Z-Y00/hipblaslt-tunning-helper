...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1317.24 | 11685.90 | 114.8% | 98.1% |
| **API bench (installed)** | 1343.18 | 11460.27 | 117.1% | — |
| **hipblaslt-bench (stock)** | 1147.25 | 13417.50 | — | — |

> **Tuned/API ratio (gate metric):** 98.07%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 28672 -k 65536 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,28672,65536,1,4096,268435456,0,28672,1879048192,4096,117440512,4096,117440512,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.14725e+06,314.421,13417.5
