...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1417.55 | 3102.57 | 115.4% | 98.5% |
| **API bench (installed)** | 1438.92 | 3056.50 | 117.1% | — |
| **hipblaslt-bench (stock)** | 1228.85 | 3578.98 | — | — |

> **Tuned/API ratio (gate metric):** 98.52%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,8192,32768,8192,1,8192,67108864,0,8192,268435456,8192,268435456,8192,268435456,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.22885e+06,314.335,3578.98
