...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1188.34 | 809.59 | 97.8% | 86.5% |
| **API bench (installed)** | 1373.99 | 700.21 | 113.0% | — |
| **hipblaslt-bench (stock)** | 1215.58 | 791.45 | — | — |

> **Tuned/API ratio (gate metric):** 86.49%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 4096 -k 28672 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,4096,28672,1,4096,117440512,0,28672,117440512,4096,16777216,4096,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.21558e+06,592.267,791.45
