...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1217.03 | 12648.20 | 113.2% | 104.4% |
| **API bench (installed)** | 1166.22 | 13199.23 | 108.4% | — |
| **hipblaslt-bench (stock)** | 1075.50 | 14312.60 | — | — |

> **Tuned/API ratio (gate metric):** 104.36%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,28672,8192,32768,1,28672,939524096,0,8192,268435456,28672,234881024,28672,234881024,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.0755e+06,187.772,14312.6
