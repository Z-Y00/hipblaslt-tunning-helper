...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1349.84 | 1641.82 | 116.7% | 102.2% |
| **API bench (installed)** | 1321.08 | 1677.57 | 114.2% | — |
| **hipblaslt-bench (stock)** | 1156.34 | 1916.56 | — | — |

> **Tuned/API ratio (gate metric):** 102.18%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 11008 -n 24576 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,11008,24576,4096,1,4096,45088768,0,4096,100663296,11008,270532608,11008,270532608,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.15634e+06,404.574,1916.56
