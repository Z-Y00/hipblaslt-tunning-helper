...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1017.04 | 14054.20 | 316.5% | 122.5% |
| **API bench (installed)** | 830.11 | 17218.90 | 258.4% | — |
| **hipblaslt-bench (stock)** | 321.31 | 44485.70 | — | — |

> **Tuned/API ratio (gate metric):** 122.52%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 53248 -n 16384 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,53248,16384,8192,1,53248,436207616,0,16384,134217728,53248,872415232,53248,872415232,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,321309,60.4126,44485.7
