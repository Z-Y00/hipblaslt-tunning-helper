...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1330.35 | 10124.40 | 109.0% | 94.9% |
| **API bench (installed)** | 1401.75 | 9608.74 | 114.8% | — |
| **hipblaslt-bench (stock)** | 1220.75 | 11033.40 | — | — |

> **Tuned/API ratio (gate metric):** 94.91%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 28672 -n 57344 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,28672,57344,4096,1,4096,117440512,0,4096,234881024,28672,1644167168,28672,1644167168,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.22075e+06,337.045,11033.4
