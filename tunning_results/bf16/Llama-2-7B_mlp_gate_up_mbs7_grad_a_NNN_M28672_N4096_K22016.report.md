...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1454.50 | 3555.26 | 148.0% | 129.9% |
| **API bench (installed)** | 1119.71 | 4618.29 | 114.0% | — |
| **hipblaslt-bench (stock)** | 982.57 | 5262.86 | — | — |

> **Tuned/API ratio (gate metric):** 129.90%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 28672 -k 22016 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,28672,22016,1,4096,90177536,0,22016,631242752,4096,117440512,4096,117440512,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,982572,296.892,5262.86
