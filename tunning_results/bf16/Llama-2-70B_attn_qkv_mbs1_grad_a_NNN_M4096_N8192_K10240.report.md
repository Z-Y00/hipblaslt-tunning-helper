...
| **API bench (installed)** | 1274.07 | 539.37 | 102.3% | — |
| **hipblaslt-bench (stock)** | 1245.87 | 551.58 | — | — |
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 4096 -k 10240 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 1840 --print_kernel_info
```
...
Rotating buffer 1840 MiB. Needed Size: 304 MiB. Needed block count: 7 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,4096,10240,1,8192,83886080,0,10240,41943040,8192,33554432,8192,33554432,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1840,0,0,1.24587e+06,538.227,551.58
