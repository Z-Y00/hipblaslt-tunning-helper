...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1365.24 | 302.01 | 1260.7% | 864.7% |
| **API bench (installed)** | 157.88 | 2611.63 | 145.8% | — |
| **hipblaslt-bench (stock)** | 108.29 | 3807.52 | — | — |

> **Tuned/API ratio (gate metric):** 864.75%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 6144 -n 8192 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 1520 --print_kernel_info
```
...
Rotating buffer 1520 MiB. Needed Size: 208 MiB. Needed block count: 8 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,6144,8192,4096,1,4096,25165824,0,4096,33554432,6144,50331648,6144,50331648,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1520,0,0,108290,53.3484,3807.52
