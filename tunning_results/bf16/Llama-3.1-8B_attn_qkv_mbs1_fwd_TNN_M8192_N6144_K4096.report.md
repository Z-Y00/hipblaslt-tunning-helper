...
| **API bench (installed)** | 1266.43 | 325.57 | 110.1% | — |
| **hipblaslt-bench (stock)** | 1150.12 | 358.50 | — | — |
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 6144 -n 8192 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 1900 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
Rotating buffer 1900 MiB. Needed Size: 208 MiB. Needed block count: 10 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,6144,8192,4096,1,4096,25165824,0,4096,33554432,6144,50331648,6144,50331648,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1900,1,1,1.15012e+06,566.599,358.499
