# Qwen2.5-72B — mlp_gate_up [grad_b]
...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1077.44 | 1841.66 | 98.6% | 88.4% |
| **API bench (installed)** | 1219.09 | 1627.66 | 111.6% | — |
| **hipblaslt-bench (stock)** | 1092.31 | 1816.58 | — | — |

> **Tuned/API ratio (gate metric):** 88.38%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 59136 -k 2048 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,59136,2048,1,8192,16777216,0,59136,121110528,8192,484442112,8192,484442112,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.09231e+06,638.11,1816.58
