...
| **API bench (installed)** | 923.46 | 73.25 | 119.9% | — |
| **hipblaslt-bench (stock)** | 770.04 | 87.85 | — | — |
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 3584 -n 4608 -k 2048 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 640 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,3584,4608,2048,1,3584,7340032,0,4608,9437184,3584,16515072,3584,16515072,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,640,1,1,770044,705.909,87.8466
