...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1212.37 | 510.14 | 839.1% | 856.7% |
| **API bench (installed)** | 141.52 | 4370.14 | 97.9% | — |
| **hipblaslt-bench (stock)** | 144.49 | 4280.30 | — | — |

> **Tuned/API ratio (gate metric):** 856.66%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 1024 -k 73728 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,1024,73728,1,4096,301989888,0,1024,75497472,4096,4194304,4096,4194304,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,144493,166.095,4280.3
