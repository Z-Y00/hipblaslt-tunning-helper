...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1175.59 | 6457.48 | 99.5% | 95.4% |
| **API bench (installed)** | 1232.76 | 6158.03 | 104.4% | — |
| **hipblaslt-bench (stock)** | 1181.29 | 6426.33 | — | — |

> **Tuned/API ratio (gate metric):** 95.36%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 7168 -n 129280 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,7168,129280,4096,1,7168,29360128,0,129280,529530880,7168,926679040,7168,926679040,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.18129e+06,430.586,6426.33
