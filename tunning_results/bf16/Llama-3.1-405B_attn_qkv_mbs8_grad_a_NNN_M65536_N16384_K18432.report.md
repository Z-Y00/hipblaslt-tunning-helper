# Llama-3.1-405B — attn_qkv [grad_a]
...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1334.95 | 29650.80 | 114.8% | 99.6% |
| **API bench (installed)** | 1340.35 | 29531.44 | 115.2% | — |
| **hipblaslt-bench (stock)** | 1163.29 | 34026.20 | — | — |

> **Tuned/API ratio (gate metric):** 99.60%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 65536 -k 18432 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,16384,65536,18432,1,16384,301989888,0,18432,1207959552,16384,1073741824,16384,1073741824,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.16329e+06,141.435,34026.2
