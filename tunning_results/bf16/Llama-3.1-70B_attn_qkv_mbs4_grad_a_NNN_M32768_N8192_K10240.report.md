...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1235.11 | 4451.08 | 99.3% | 87.7% |
| **API bench (installed)** | 1407.73 | 3905.28 | 113.2% | — |
| **hipblaslt-bench (stock)** | 1243.21 | 4422.07 | — | — |

> **Tuned/API ratio (gate metric):** 87.74%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 32768 -k 10240 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,32768,10240,1,8192,83886080,0,10240,335544320,8192,268435456,8192,268435456,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.24321e+06,289.74,4422.07
