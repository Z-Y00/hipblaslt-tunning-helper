...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1341.01 | 22957.60 | 110.2% | 98.5% |
| **API bench (installed)** | 1361.65 | 22609.55 | 111.9% | — |
| **hipblaslt-bench (stock)** | 1217.16 | 25293.50 | — | — |

> **Tuned/API ratio (gate metric):** 98.48%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,32768,57344,1,8192,469762048,0,57344,1879048192,8192,268435456,8192,268435456,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.21716e+06,192.737,25293.5
