...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1062.31 | 94186.40 | 97.6% | 84.5% |
| **API bench (installed)** | 1257.59 | 79561.63 | 115.5% | — |
| **hipblaslt-bench (stock)** | 1088.88 | 91888.20 | — | — |

> **Tuned/API ratio (gate metric):** 84.47%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 53248 -n 16384 -k 57344 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,53248,16384,57344,1,53248,3053453312,0,16384,939524096,53248,872415232,53248,872415232,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.08888e+06,98.6253,91888.2
