...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1395.93 | 1323.01 | 118.2% | 103.7% |
| **API bench (installed)** | 1345.80 | 1372.29 | 114.0% | — |
| **hipblaslt-bench (stock)** | 1180.77 | 1564.10 | — | — |

> **Tuned/API ratio (gate metric):** 103.72%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 11008 -n 20480 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,11008,20480,4096,1,11008,45088768,0,4096,83886080,11008,225443840,11008,225443840,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.18077e+06,422.068,1564.1
