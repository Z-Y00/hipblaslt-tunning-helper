...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1030.17 | 533.65 | 102.5% | 1586.4% |
| **API bench (installed)** | 64.94 | 8465.94 | 6.5% | — |
| **hipblaslt-bench (stock)** | 1005.30 | 546.86 | — | — |

> **Tuned/API ratio (gate metric):** 1586.40%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 65536 -k 1024 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,65536,1024,1,4096,4194304,0,1024,67108864,4096,268435456,4096,268435456,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.0053e+06,1157.17,546.86
