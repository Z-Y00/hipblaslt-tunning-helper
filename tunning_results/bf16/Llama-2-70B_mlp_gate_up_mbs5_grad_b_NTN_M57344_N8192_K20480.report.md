# Llama-2-70B — mlp_gate_up [grad_b]
...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1302.62 | 14771.40 | 112.5% | 97.3% |
| **API bench (installed)** | 1339.41 | 14365.62 | 115.7% | — |
| **hipblaslt-bench (stock)** | 1157.92 | 16617.20 | — | — |

> **Tuned/API ratio (gate metric):** 97.25%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 57344 -k 20480 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,57344,20480,1,8192,167772160,0,57344,1174405120,8192,469762048,8192,469762048,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.15792e+06,203.102,16617.2
