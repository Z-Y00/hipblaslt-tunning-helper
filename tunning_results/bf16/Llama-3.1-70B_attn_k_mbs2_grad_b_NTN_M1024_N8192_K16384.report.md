...
| **API bench (installed)** | 1041.35 | 263.96 | 117.4% | — |
| **hipblaslt-bench (stock)** | 886.93 | 309.92 | — | — |
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 1024 -k 16384 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 2000 --print_kernel_info
```
...
Rotating buffer 2000 MiB. Needed Size: 304 MiB. Needed block count: 7 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,1024,16384,1,8192,134217728,0,1024,16777216,8192,8388608,8192,8388608,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2000,0,0,886932,957.908,309.92
