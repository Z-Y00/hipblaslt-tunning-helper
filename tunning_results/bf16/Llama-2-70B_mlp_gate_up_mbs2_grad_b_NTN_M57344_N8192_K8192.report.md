...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1296.83 | 5934.93 | 107.2% | 96.0% |
| **API bench (installed)** | 1351.50 | 5694.83 | 111.7% | — |
| **hipblaslt-bench (stock)** | 1209.95 | 6361.06 | — | — |

> **Tuned/API ratio (gate metric):** 95.95%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,57344,8192,1,8192,67108864,0,57344,469762048,8192,469762048,8192,469762048,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.20995e+06,294.762,6361.06
