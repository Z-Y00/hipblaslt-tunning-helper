...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1355.95 | 405.44 | 115.2% | 96.5% |
| **API bench (installed)** | 1405.17 | 391.24 | 119.3% | — |
| **hipblaslt-bench (stock)** | 1177.36 | 466.94 | — | — |

> **Tuned/API ratio (gate metric):** 96.50%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 16384 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 2080 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,16384,4096,1,4096,16777216,0,4096,67108864,4096,67108864,4096,67108864,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2080,0,0,1.17736e+06,602.326,466.94
