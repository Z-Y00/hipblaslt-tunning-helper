...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1405.04 | 525.78 | 115.4% | 98.2% |
| **API bench (installed)** | 1430.17 | 516.53 | 117.5% | — |
| **hipblaslt-bench (stock)** | 1217.07 | 606.98 | — | — |

> **Tuned/API ratio (gate metric):** 98.24%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 8192 -k 11008 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 1930 --print_kernel_info
```
...
Rotating buffer 1930 MiB. Needed Size: 322 MiB. Needed block count: 6 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,4096,8192,11008,1,11008,45088768,0,11008,90177536,4096,33554432,4096,33554432,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1930,0,0,1.21707e+06,518.062,606.98
