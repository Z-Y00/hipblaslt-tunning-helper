...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1340.13 | 1435.79 | 109.0% | 95.3% |
| **API bench (installed)** | 1406.82 | 1367.73 | 114.4% | — |
| **hipblaslt-bench (stock)** | 1229.28 | 1565.26 | — | — |

> **Tuned/API ratio (gate metric):** 95.26%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 28672 -n 4096 -k 8192 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,28672,4096,8192,1,8192,234881024,0,8192,33554432,28672,117440512,28672,117440512,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.22928e+06,459.189,1565.26
