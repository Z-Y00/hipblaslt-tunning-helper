...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1361.76 | 2422.26 | 152.0% | 137.4% |
| **API bench (installed)** | 991.16 | 3327.96 | 110.7% | — |
| **hipblaslt-bench (stock)** | 895.65 | 3682.84 | — | — |

> **Tuned/API ratio (gate metric):** 137.39%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 32768 -k 12288 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,32768,12288,1,4096,50331648,0,12288,402653184,4096,134217728,4096,134217728,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,895650,296.985,3682.84
