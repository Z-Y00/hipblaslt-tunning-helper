...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1279.92 | 6765.00 | 117.4% | 101.5% |
| **API bench (installed)** | 1261.25 | 6865.15 | 115.7% | — |
| **hipblaslt-bench (stock)** | 1089.97 | 7943.92 | — | — |

> **Tuned/API ratio (gate metric):** 101.48%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 14336 -k 73728 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,14336,73728,1,4096,301989888,0,14336,1056964608,4096,58720256,4096,58720256,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.08997e+06,332.408,7943.92
