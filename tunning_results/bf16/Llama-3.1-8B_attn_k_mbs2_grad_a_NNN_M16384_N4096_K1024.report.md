...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 987.94 | 139.12 | 119.7% | 102.5% |
| **API bench (installed)** | 964.25 | 142.53 | 116.8% | — |
| **hipblaslt-bench (stock)** | 825.26 | 166.54 | — | — |

> **Tuned/API ratio (gate metric):** 102.46%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 16384 -k 1024 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 1480 --print_kernel_info
```
...
Rotating buffer 1480 MiB. Needed Size: 168 MiB. Needed block count: 9 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,16384,1024,1,4096,4194304,0,1024,16777216,4096,67108864,4096,67108864,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1480,0,0,825261,985.124,166.54
