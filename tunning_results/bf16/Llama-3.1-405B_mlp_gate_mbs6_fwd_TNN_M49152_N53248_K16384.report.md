...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1442.09 | 59470.50 | 110.8% | 101.1% |
| **API bench (installed)** | 1426.49 | 60120.87 | 109.6% | — |
| **hipblaslt-bench (stock)** | 1301.43 | 65898.10 | — | — |

> **Tuned/API ratio (gate metric):** 101.09%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 53248 -n 49152 -k 16384 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,53248,49152,16384,1,16384,872415232,0,16384,805306368,53248,2617245696,53248,2617245696,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.30143e+06,121.399,65898.1
