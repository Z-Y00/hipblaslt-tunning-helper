...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1357.47 | 11339.60 | 109.2% | 98.8% |
| **API bench (installed)** | 1373.89 | 11204.07 | 110.5% | — |
| **hipblaslt-bench (stock)** | 1243.11 | 12382.80 | — | — |

> **Tuned/API ratio (gate metric):** 98.80%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,16384,57344,1,8192,469762048,0,57344,939524096,8192,134217728,8192,134217728,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.24311e+06,232.177,12382.8
