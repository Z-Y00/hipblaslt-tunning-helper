...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1341.36 | 819.70 | 110.3% | 106.4% |
| **API bench (installed)** | 1260.21 | 872.48 | 103.6% | — |
| **hipblaslt-bench (stock)** | 1216.62 | 903.74 | — | — |

> **Tuned/API ratio (gate metric):** 106.44%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,4096,32768,1,4096,134217728,0,4096,134217728,4096,16777216,4096,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.21662e+06,587.835,903.74
