...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1264.04 | 1522.21 | 109.4% | 97.1% |
| **API bench (installed)** | 1302.13 | 1477.69 | 112.7% | — |
| **hipblaslt-bench (stock)** | 1155.21 | 1665.62 | — | — |

> **Tuned/API ratio (gate metric):** 97.07%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 14336 -n 4096 -k 16384 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,14336,4096,16384,1,14336,234881024,0,4096,67108864,14336,58720256,14336,58720256,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.15521e+06,403.378,1665.62
