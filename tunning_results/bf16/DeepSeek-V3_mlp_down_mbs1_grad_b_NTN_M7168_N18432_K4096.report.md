...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1175.79 | 920.51 | 97.6% | 88.5% |
| **API bench (installed)** | 1329.05 | 814.37 | 110.3% | — |
| **hipblaslt-bench (stock)** | 1204.68 | 898.44 | — | — |

> **Tuned/API ratio (gate metric):** 88.47%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 18432 -n 7168 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,18432,7168,4096,1,18432,75497472,0,7168,29360128,18432,132120576,18432,132120576,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.20468e+06,491.304,898.438
