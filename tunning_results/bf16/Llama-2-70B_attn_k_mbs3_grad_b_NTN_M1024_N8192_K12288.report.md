...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 957.42 | 215.33 | 1003.4% | 821.7% |
| **API bench (installed)** | 116.52 | 1769.35 | 122.1% | — |
| **hipblaslt-bench (stock)** | 95.42 | 2160.58 | — | — |

> **Tuned/API ratio (gate metric):** 821.70%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 1024 -k 12288 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 1240 --print_kernel_info
```
...
Rotating buffer 1240 MiB. Needed Size: 232 MiB. Needed block count: 6 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,1024,12288,1,8192,100663296,0,1024,12582912,8192,8388608,8192,8388608,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1240,0,0,95418.1,104.862,2160.58
