...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1150.90 | 59828.70 | 99.5% | 89.1% |
| **API bench (installed)** | 1291.37 | 53320.99 | 111.6% | — |
| **hipblaslt-bench (stock)** | 1157.11 | 59507.60 | — | — |

> **Tuned/API ratio (gate metric):** 89.12%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 128256 -k 32768 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,128256,32768,1,8192,268435456,0,128256,4202692608,8192,1050673152,8192,1050673152,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.15711e+06,172.838,59507.6
