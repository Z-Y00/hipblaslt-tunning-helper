...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1323.89 | 5813.60 | 110.8% | 97.4% |
| **API bench (installed)** | 1359.27 | 5662.31 | 113.8% | — |
| **hipblaslt-bench (stock)** | 1194.46 | 6443.54 | — | — |

> **Tuned/API ratio (gate metric):** 97.40%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,8192,57344,1,8192,469762048,0,57344,469762048,8192,67108864,8192,67108864,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.19446e+06,290.989,6443.54
