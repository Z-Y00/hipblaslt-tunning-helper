...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1398.78 | 2751.17 | 113.1% | 111.6% |
| **API bench (installed)** | 1253.14 | 3070.92 | 101.3% | — |
| **hipblaslt-bench (stock)** | 1237.02 | 3110.94 | — | — |

> **Tuned/API ratio (gate metric):** 111.62%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 32768 -k 14336 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,32768,14336,1,4096,58720256,0,14336,469762048,4096,134217728,4096,134217728,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.23702e+06,396.785,3110.94
