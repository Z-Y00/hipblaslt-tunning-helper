...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1222.65 | 393.44 | 119.3% | 106.9% |
| **API bench (installed)** | 1143.36 | 420.72 | 111.6% | — |
| **hipblaslt-bench (stock)** | 1024.48 | 469.54 | — | — |

> **Tuned/API ratio (gate metric):** 106.93%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 1024 -n 57344 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,1024,57344,4096,1,4096,4194304,0,4096,234881024,1024,58720256,1024,58720256,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.02448e+06,1181.34,469.54
