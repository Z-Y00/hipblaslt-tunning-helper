...
| **API bench (installed)** | 991.74 | 280.42 | 94.3% | — |
| **hipblaslt-bench (stock)** | 1051.73 | 264.42 | — | — |
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 3584 -n 2048 -k 18944 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 1447 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
Rotating buffer 1447 MiB. Needed Size: 217 MiB. Needed block count: 7 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,3584,2048,18944,1,18944,67895296,0,18944,38797312,3584,7340032,3584,7340032,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1447,1,1,1.05173e+06,803.278,264.42
