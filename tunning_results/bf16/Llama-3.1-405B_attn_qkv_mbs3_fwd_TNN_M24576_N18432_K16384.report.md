...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1431.64 | 10368.10 | 112.7% | 102.2% |
| **API bench (installed)** | 1401.32 | 10592.47 | 110.3% | — |
| **hipblaslt-bench (stock)** | 1270.24 | 11685.50 | — | — |

> **Tuned/API ratio (gate metric):** 102.16%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 18432 -n 24576 -k 16384 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,18432,24576,16384,1,16384,301989888,0,16384,402653184,18432,452984832,18432,452984832,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.27024e+06,184.523,11685.5
