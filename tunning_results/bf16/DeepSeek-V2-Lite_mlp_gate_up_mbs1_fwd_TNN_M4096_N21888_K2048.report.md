# DeepSeek-V2-Lite — mlp_gate_up [fwd]
...
| **API bench (installed)** | 1037.97 | 353.79 | 107.6% | — |
| **hipblaslt-bench (stock)** | 964.25 | 380.83 | — | — |
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 21888 -n 4096 -k 2048 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 2772 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
Rotating buffer 2772 MiB. Needed Size: 272 MiB. Needed block count: 1 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,21888,4096,2048,1,2048,44826624,0,2048,8388608,21888,89653248,21888,89653248,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2772,1,1,964251,698.764,380.834
