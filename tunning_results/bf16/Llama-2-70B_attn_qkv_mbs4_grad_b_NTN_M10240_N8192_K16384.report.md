...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1367.29 | 2010.38 | 111.3% | 99.5% |
| **API bench (installed)** | 1373.52 | 2001.27 | 111.8% | — |
| **hipblaslt-bench (stock)** | 1228.48 | 2237.54 | — | — |

> **Tuned/API ratio (gate metric):** 99.55%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,10240,16384,1,8192,134217728,0,10240,167772160,8192,83886080,8192,83886080,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.22848e+06,321.223,2237.54
