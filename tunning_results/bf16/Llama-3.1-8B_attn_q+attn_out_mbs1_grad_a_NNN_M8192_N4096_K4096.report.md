...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1291.13 | 212.90 | 117.7% | 104.1% |
| **API bench (installed)** | 1240.56 | 221.58 | 113.1% | — |
| **hipblaslt-bench (stock)** | 1096.53 | 250.68 | — | — |

> **Tuned/API ratio (gate metric):** 104.08%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,8192,4096,1,4096,16777216,0,4096,33554432,4096,33554432,4096,33554432,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1120,0,0,1.09653e+06,623.305,250.68
