...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1338.81 | 53382.10 | 110.2% | 96.6% |
| **API bench (installed)** | 1386.41 | 51549.22 | 114.1% | — |
| **hipblaslt-bench (stock)** | 1215.34 | 58805.40 | — | — |

> **Tuned/API ratio (gate metric):** 96.57%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 53248 -k 40960 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,53248,40960,1,16384,671088640,0,53248,2181038080,16384,872415232,16384,872415232,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.21534e+06,117.974,58805.4
