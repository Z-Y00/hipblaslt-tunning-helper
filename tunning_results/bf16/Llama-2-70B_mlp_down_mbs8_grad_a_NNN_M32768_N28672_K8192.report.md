...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1372.69 | 11213.90 | 112.4% | 96.8% |
| **API bench (installed)** | 1418.22 | 10853.84 | 116.1% | — |
| **hipblaslt-bench (stock)** | 1221.73 | 12599.50 | — | — |

> **Tuned/API ratio (gate metric):** 96.79%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,28672,32768,8192,1,28672,234881024,0,8192,268435456,28672,939524096,28672,939524096,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.22173e+06,213.303,12599.5
