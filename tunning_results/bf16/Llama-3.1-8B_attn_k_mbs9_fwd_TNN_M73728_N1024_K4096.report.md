...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1244.93 | 496.79 | 114.7% | 103.0% |
| **API bench (installed)** | 1209.05 | 511.54 | 111.4% | — |
| **hipblaslt-bench (stock)** | 1085.39 | 569.82 | — | — |

> **Tuned/API ratio (gate metric):** 102.97%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 1024 -n 73728 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,1024,73728,4096,1,4096,4194304,0,4096,301989888,1024,75497472,1024,75497472,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.08539e+06,1247.65,569.82
