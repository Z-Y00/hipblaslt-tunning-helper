...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1414.90 | 1748.46 | 115.0% | 112.9% |
| **API bench (installed)** | 1252.93 | 1974.49 | 101.8% | — |
| **hipblaslt-bench (stock)** | 1230.87 | 2009.88 | — | — |

> **Tuned/API ratio (gate metric):** 112.93%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 12288 -k 24576 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,12288,24576,1,4096,100663296,0,12288,301989888,4096,50331648,4096,50331648,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.23087e+06,419.801,2009.88
