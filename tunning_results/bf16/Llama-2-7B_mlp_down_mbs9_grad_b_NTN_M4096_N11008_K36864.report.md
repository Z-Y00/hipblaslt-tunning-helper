...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1048.53 | 3170.46 | 290.6% | 290.0% |
| **API bench (installed)** | 361.51 | 9195.52 | 100.2% | — |
| **hipblaslt-bench (stock)** | 360.85 | 9212.48 | — | — |

> **Tuned/API ratio (gate metric):** 290.04%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 11008 -n 4096 -k 36864 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,11008,4096,36864,1,11008,405798912,0,4096,150994944,11008,45088768,11008,45088768,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,360848,121.693,9212.48
