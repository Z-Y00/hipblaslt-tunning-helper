...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1098.37 | 903.28 | 98.0% | 89.7% |
| **API bench (installed)** | 1224.87 | 810.00 | 109.3% | — |
| **hipblaslt-bench (stock)** | 1120.90 | 885.13 | — | — |

> **Tuned/API ratio (gate metric):** 89.67%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 29568 -n 8192 -k 2048 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,29568,8192,2048,1,29568,60555264,0,8192,16777216,29568,242221056,29568,242221056,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.1209e+06,672.461,885.129
