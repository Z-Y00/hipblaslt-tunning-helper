# Llama-2-70B — attn_q+attn_out [grad_a]
...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1188.46 | 462.58 | 97.0% | 91.6% |
| **API bench (installed)** | 1297.47 | 423.71 | 105.8% | — |
| **hipblaslt-bench (stock)** | 1225.82 | 448.48 | — | — |

> **Tuned/API ratio (gate metric):** 91.60%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 4096 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 2000 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
Rotating buffer 2000 MiB. Needed Size: 256 MiB. Needed block count: 8 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,4096,8192,1,8192,67108864,0,8192,33554432,8192,33554432,8192,33554432,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2000,1,1,1.22582e+06,557.44,448.479
