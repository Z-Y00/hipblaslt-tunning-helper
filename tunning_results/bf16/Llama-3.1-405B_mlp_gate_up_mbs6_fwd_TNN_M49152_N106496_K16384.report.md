...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1371.36 | 125076.00 | 111.8% | 99.4% |
| **API bench (installed)** | 1379.05 | 124378.43 | 112.5% | — |
| **hipblaslt-bench (stock)** | 1226.22 | 139880.00 | — | — |

> **Tuned/API ratio (gate metric):** 99.44%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 106496 -n 49152 -k 16384 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,106496,49152,16384,1,16384,1744830464,0,16384,805306368,106496,5234491392,106496,5234491392,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.22622e+06,103.66,139880
