...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1332.58 | 4331.78 | 127.0% | 100.5% |
| **API bench (installed)** | 1325.64 | 4354.44 | 126.3% | — |
| **hipblaslt-bench (stock)** | 1049.21 | 5501.68 | — | — |

> **Tuned/API ratio (gate metric):** 100.52%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 14336 -n 49152 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,14336,49152,4096,1,14336,58720256,0,4096,201326592,14336,704643072,14336,704643072,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.04921e+06,326.605,5501.68
