...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1503.69 | 2924.84 | 117.9% | 100.6% |
| **API bench (installed)** | 1494.93 | 2941.97 | 117.3% | — |
| **hipblaslt-bench (stock)** | 1274.91 | 3449.68 | — | — |

> **Tuned/API ratio (gate metric):** 100.59%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,8192,32768,8192,1,8192,67108864,0,8192,268435456,8192,268435456,8192,268435456,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.27491e+06,326.117,3449.68
