...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1215.07 | 452.45 | 112.8% | 100.4% |
| **API bench (installed)** | 1210.03 | 454.33 | 112.3% | — |
| **hipblaslt-bench (stock)** | 1077.23 | 510.34 | — | — |

> **Tuned/API ratio (gate metric):** 100.42%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,1024,32768,1,8192,268435456,0,1024,33554432,8192,8388608,8192,8388608,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.07723e+06,1132.82,510.34
