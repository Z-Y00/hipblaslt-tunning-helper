...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1460.37 | 3293.93 | 112.7% | 96.9% |
| **API bench (installed)** | 1507.02 | 3191.96 | 116.3% | — |
| **hipblaslt-bench (stock)** | 1295.71 | 3712.54 | — | — |

> **Tuned/API ratio (gate metric):** 96.90%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 40960 -k 14336 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,4096,40960,14336,1,14336,58720256,0,14336,587202560,4096,167772160,4096,167772160,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.29571e+06,408.245,3712.54
