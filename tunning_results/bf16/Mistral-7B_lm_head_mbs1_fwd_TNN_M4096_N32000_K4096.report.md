...
| **API bench (installed)** | 1377.76 | 779.34 | 114.1% | — |
| **hipblaslt-bench (stock)** | 1208.03 | 888.84 | — | — |
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 32000 -n 4096 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,32000,4096,4096,1,4096,131072000,0,4096,16777216,32000,131072000,32000,131072000,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.20803e+06,584.506,888.838
