...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1375.15 | 3498.06 | 111.3% | 94.7% |
| **API bench (installed)** | 1451.88 | 3313.19 | 117.5% | — |
| **hipblaslt-bench (stock)** | 1235.21 | 3894.38 | — | — |

> **Tuned/API ratio (gate metric):** 94.72%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 14336 -n 40960 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,14336,40960,4096,1,4096,58720256,0,4096,167772160,14336,587202560,14336,587202560,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.23521e+06,389.183,3894.38
