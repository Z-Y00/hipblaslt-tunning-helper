...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1264.34 | 849.25 | 98.3% | 86.5% |
| **API bench (installed)** | 1462.38 | 734.24 | 113.6% | — |
| **hipblaslt-bench (stock)** | 1286.80 | 834.43 | — | — |

> **Tuned/API ratio (gate metric):** 86.46%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,4096,32000,1,4096,131072000,0,32000,131072000,4096,16777216,4096,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.2868e+06,622.619,834.429
