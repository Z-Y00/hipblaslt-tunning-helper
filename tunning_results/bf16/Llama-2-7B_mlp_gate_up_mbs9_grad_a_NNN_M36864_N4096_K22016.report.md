...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1406.91 | 4725.67 | 115.3% | 112.0% |
| **API bench (installed)** | 1255.91 | 5293.85 | 103.0% | — |
| **hipblaslt-bench (stock)** | 1219.72 | 5450.92 | — | — |

> **Tuned/API ratio (gate metric):** 112.02%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 36864 -k 22016 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,36864,22016,1,4096,90177536,0,22016,811597824,4096,150994944,4096,150994944,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.21972e+06,359.744,5450.92
