...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1194.34 | 1726.12 | 128.5% | 115.3% |
| **API bench (installed)** | 1035.81 | 1990.30 | 111.5% | — |
| **hipblaslt-bench (stock)** | 929.32 | 2218.38 | — | — |

> **Tuned/API ratio (gate metric):** 115.30%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 6144 -k 40960 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,6144,40960,1,4096,167772160,0,6144,251658240,4096,25165824,4096,25165824,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,929320,373.302,2218.38
...
**Tensile-only params:** `CMS`, `AG=0`, `DTVSM=0`, `DPLB=0`, `ELFLR=0`, `EMLL=n1`, `GSUAMBSK`, `LDSTI=0`, `MGRIPM=1`, `SGROB=0`, `SKFTR=0`, `SGRO=0`, `TIN=0`, `TLDSM=n1`, `UPLRP=1`
