# Llama-3.1-405B — attn_qkv [grad_b]
...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1349.04 | 18338.30 | 116.1% | 100.4% |
| **API bench (installed)** | 1343.95 | 18407.73 | 115.7% | — |
| **hipblaslt-bench (stock)** | 1161.84 | 21292.90 | — | — |

> **Tuned/API ratio (gate metric):** 100.38%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 18432 -k 40960 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,18432,40960,1,16384,671088640,0,18432,754974720,16384,301989888,16384,301989888,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.16184e+06,151.165,21292.9
