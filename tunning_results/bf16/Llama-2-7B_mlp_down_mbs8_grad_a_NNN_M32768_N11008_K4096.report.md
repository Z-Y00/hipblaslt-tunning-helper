...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1381.34 | 2139.18 | 175.9% | 149.8% |
| **API bench (installed)** | 921.86 | 3205.39 | 117.4% | — |
| **hipblaslt-bench (stock)** | 785.43 | 3762.20 | — | — |

> **Tuned/API ratio (gate metric):** 149.84%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 11008 -n 32768 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,11008,32768,4096,1,11008,45088768,0,4096,134217728,11008,360710144,11008,360710144,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,785428,267.359,3762.2
