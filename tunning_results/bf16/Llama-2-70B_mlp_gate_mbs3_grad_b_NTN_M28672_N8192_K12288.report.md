...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1408.20 | 4099.16 | 111.7% | 97.9% |
| **API bench (installed)** | 1438.62 | 4012.47 | 114.2% | — |
| **hipblaslt-bench (stock)** | 1260.20 | 4580.58 | — | — |

> **Tuned/API ratio (gate metric):** 97.89%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 28672 -k 12288 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,28672,12288,1,8192,100663296,0,28672,352321536,8192,234881024,8192,234881024,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.2602e+06,279.713,4580.58
