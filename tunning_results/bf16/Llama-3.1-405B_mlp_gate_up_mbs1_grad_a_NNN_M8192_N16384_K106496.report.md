...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1364.94 | 20943.90 | 145.5% | 106.7% |
| **API bench (installed)** | 1279.22 | 22347.38 | 136.3% | — |
| **hipblaslt-bench (stock)** | 938.39 | 30464.30 | — | — |

> **Tuned/API ratio (gate metric):** 106.70%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 8192 -k 106496 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,16384,8192,106496,1,16384,1744830464,0,106496,872415232,16384,134217728,16384,134217728,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,938387,168.23,30464.3
