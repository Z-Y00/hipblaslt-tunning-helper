...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1183.84 | 24147.90 | 96.9% | 86.6% |
| **API bench (installed)** | 1366.48 | 20920.42 | 111.9% | — |
| **hipblaslt-bench (stock)** | 1221.41 | 23405.20 | — | — |

> **Tuned/API ratio (gate metric):** 86.63%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 8192 -k 106496 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,16384,8192,106496,1,16384,1744830464,0,106496,872415232,16384,134217728,16384,134217728,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.22141e+06,218.968,23405.2
