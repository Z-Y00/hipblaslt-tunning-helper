...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1004.52 | 205.23 | 109.7% | 98.5% |
| **API bench (installed)** | 1019.82 | 202.15 | 111.3% | — |
| **hipblaslt-bench (stock)** | 915.93 | 225.08 | — | — |

> **Tuned/API ratio (gate metric):** 98.50%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 24576 -k 1024 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 2200 --print_kernel_info
```
...
Rotating buffer 2200 MiB. Needed Size: 248 MiB. Needed block count: 1 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,24576,1024,1,4096,4194304,0,1024,25165824,4096,100663296,4096,100663296,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2200,0,0,915934,1076.01,225.08
