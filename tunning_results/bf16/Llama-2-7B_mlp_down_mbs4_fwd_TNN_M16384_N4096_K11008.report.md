...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1508.52 | 979.42 | 113.8% | 100.2% |
| **API bench (installed)** | 1506.02 | 981.04 | 113.6% | — |
| **hipblaslt-bench (stock)** | 1325.27 | 1114.84 | — | — |

> **Tuned/API ratio (gate metric):** 100.17%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 16384 -k 11008 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,4096,16384,11008,1,11008,45088768,0,11008,180355072,4096,67108864,4096,67108864,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.32527e+06,488.789,1114.84
