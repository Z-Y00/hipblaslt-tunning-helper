...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1438.50 | 668.80 | 114.9% | 100.3% |
| **API bench (installed)** | 1434.12 | 670.85 | 114.5% | — |
| **hipblaslt-bench (stock)** | 1252.31 | 768.24 | — | — |

> **Tuned/API ratio (gate metric):** 100.31%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 8192 -k 14336 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 2320 --print_kernel_info
```
...
Rotating buffer 2320 MiB. Needed Size: 400 MiB. Needed block count: 1 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,8192,14336,1,4096,58720256,0,14336,117440512,4096,33554432,4096,33554432,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2320,0,0,1.25231e+06,508.467,768.24
