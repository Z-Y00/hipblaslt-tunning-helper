...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1354.01 | 1909.57 | 114.8% | 98.3% |
| **API bench (installed)** | 1376.88 | 1877.85 | 116.7% | — |
| **hipblaslt-bench (stock)** | 1179.90 | 2191.34 | — | — |

> **Tuned/API ratio (gate metric):** 98.34%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 11008 -n 28672 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,11008,28672,4096,1,4096,45088768,0,4096,117440512,11008,315621376,11008,315621376,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.1799e+06,406.429,2191.34
