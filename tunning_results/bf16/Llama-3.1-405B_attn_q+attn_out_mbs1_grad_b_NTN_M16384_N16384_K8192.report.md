...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1367.32 | 3216.53 | 110.3% | 96.7% |
| **API bench (installed)** | 1414.62 | 3109.00 | 114.1% | — |
| **hipblaslt-bench (stock)** | 1239.38 | 3548.58 | — | — |

> **Tuned/API ratio (gate metric):** 96.66%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 16384 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,16384,8192,1,16384,134217728,0,16384,134217728,16384,268435456,16384,268435456,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.23938e+06,281.803,3548.58
