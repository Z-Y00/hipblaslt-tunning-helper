...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1262.90 | 584.95 | 114.2% | 98.4% |
| **API bench (installed)** | 1284.08 | 575.30 | 116.2% | — |
| **hipblaslt-bench (stock)** | 1105.49 | 668.24 | — | — |

> **Tuned/API ratio (gate metric):** 98.35%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 11008 -n 8192 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 2470 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,11008,8192,4096,1,11008,45088768,0,4096,33554432,11008,90177536,11008,90177536,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2470,0,0,1.10549e+06,470.569,668.24
