...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1350.79 | 1640.67 | 114.8% | 100.1% |
| **API bench (installed)** | 1349.98 | 1641.66 | 114.8% | — |
| **hipblaslt-bench (stock)** | 1176.18 | 1884.24 | — | — |

> **Tuned/API ratio (gate metric):** 100.06%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 11008 -k 24576 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,11008,24576,1,4096,100663296,0,11008,270532608,4096,45088768,4096,45088768,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.17618e+06,411.514,1884.24
