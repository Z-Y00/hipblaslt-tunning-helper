...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1278.62 | 752.43 | 903.1% | 1655.0% |
| **API bench (installed)** | 77.26 | 12452.92 | 54.6% | — |
| **hipblaslt-bench (stock)** | 141.59 | 6795.00 | — | — |

> **Tuned/API ratio (gate metric):** 1655.03%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 14336 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,14336,8192,1,4096,33554432,0,14336,117440512,4096,58720256,4096,58720256,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,141585,57.4871,6795
