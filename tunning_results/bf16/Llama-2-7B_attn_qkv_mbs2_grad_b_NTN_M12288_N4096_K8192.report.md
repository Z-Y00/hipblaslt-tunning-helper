...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1419.71 | 580.85 | 126.9% | 98.7% |
| **API bench (installed)** | 1438.69 | 573.18 | 128.6% | — |
| **hipblaslt-bench (stock)** | 1118.85 | 737.04 | — | — |

> **Tuned/API ratio (gate metric):** 98.68%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 12288 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 2240 --print_kernel_info
```
...
Rotating buffer 2240 MiB. Needed Size: 352 MiB. Needed block count: 1 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,12288,8192,1,4096,33554432,0,12288,100663296,4096,50331648,4096,50331648,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2240,0,0,1.11885e+06,466.393,737.04
