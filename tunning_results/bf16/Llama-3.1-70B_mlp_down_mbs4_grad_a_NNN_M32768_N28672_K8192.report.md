...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1134.40 | 13569.50 | 95.7% | 85.0% |
| **API bench (installed)** | 1335.13 | 11529.37 | 112.7% | — |
| **hipblaslt-bench (stock)** | 1184.76 | 12992.70 | — | — |

> **Tuned/API ratio (gate metric):** 84.97%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 28672 -n 32768 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,28672,32768,8192,1,28672,234881024,0,8192,268435456,28672,939524096,28672,939524096,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.18476e+06,206.847,12992.7
