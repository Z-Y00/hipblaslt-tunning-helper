...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1397.44 | 11015.30 | 111.9% | 101.4% |
| **API bench (installed)** | 1378.20 | 11169.00 | 110.4% | — |
| **hipblaslt-bench (stock)** | 1248.62 | 12328.10 | — | — |

> **Tuned/API ratio (gate metric):** 101.40%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,28672,32768,8192,1,28672,234881024,0,8192,268435456,28672,939524096,28672,939524096,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.24862e+06,217.998,12328.1
