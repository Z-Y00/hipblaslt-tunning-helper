...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1270.59 | 7571.88 | 108.2% | 95.0% |
| **API bench (installed)** | 1337.37 | 7193.78 | 113.8% | — |
| **hipblaslt-bench (stock)** | 1174.71 | 8189.88 | — | — |

> **Tuned/API ratio (gate metric):** 95.01%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 28672 -n 40960 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,28672,40960,4096,1,4096,117440512,0,4096,167772160,28672,1174405120,28672,1174405120,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.17471e+06,331.965,8189.88
