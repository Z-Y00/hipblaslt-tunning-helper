...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 946.01 | 508.49 | 1118.7% | 869.4% |
| **API bench (installed)** | 108.81 | 4420.99 | 128.7% | — |
| **hipblaslt-bench (stock)** | 84.57 | 5688.30 | — | — |

> **Tuned/API ratio (gate metric):** 869.43%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 1024 -k 28672 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,1024,28672,1,8192,234881024,0,1024,29360128,8192,8388608,8192,8388608,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,84565.9,89.2732,5688.3
