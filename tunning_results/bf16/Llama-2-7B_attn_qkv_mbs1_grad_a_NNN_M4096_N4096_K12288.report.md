...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1146.06 | 359.77 | 98.9% | 87.0% |
| **API bench (installed)** | 1316.64 | 313.16 | 113.6% | — |
| **hipblaslt-bench (stock)** | 1159.04 | 355.74 | — | — |

> **Tuned/API ratio (gate metric):** 87.04%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 4096 -k 12288 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 1600 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,4096,12288,1,4096,50331648,0,12288,50331648,4096,16777216,4096,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1600,1,1,1.15904e+06,614.916,355.739
