...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1298.05 | 317.64 | 126.8% | 101.4% |
| **API bench (installed)** | 1279.59 | 322.23 | 125.0% | — |
| **hipblaslt-bench (stock)** | 1023.32 | 402.92 | — | — |

> **Tuned/API ratio (gate metric):** 101.44%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 8192 -k 6144 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 1360 --print_kernel_info
```
...
Rotating buffer 1360 MiB. Needed Size: 208 MiB. Needed block count: 7 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,8192,6144,1,4096,25165824,0,6144,50331648,4096,33554432,4096,33554432,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1360,0,0,1.02332e+06,504.132,402.92
