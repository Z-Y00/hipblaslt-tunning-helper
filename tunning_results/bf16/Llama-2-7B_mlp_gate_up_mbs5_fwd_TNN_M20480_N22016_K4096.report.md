...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1292.39 | 2858.02 | 108.0% | 96.6% |
| **API bench (installed)** | 1338.02 | 2760.55 | 111.9% | — |
| **hipblaslt-bench (stock)** | 1196.11 | 3088.06 | — | — |

> **Tuned/API ratio (gate metric):** 96.59%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 22016 -n 20480 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,22016,20480,4096,1,4096,90177536,0,4096,83886080,22016,450887680,22016,450887680,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.19611e+06,376.956,3088.06
