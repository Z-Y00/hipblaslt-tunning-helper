...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1366.39 | 905.27 | 115.2% | 98.9% |
| **API bench (installed)** | 1381.24 | 895.54 | 116.4% | — |
| **hipblaslt-bench (stock)** | 1186.41 | 1042.60 | — | — |

> **Tuned/API ratio (gate metric):** 98.93%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 36864 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,4096,36864,4096,1,4096,16777216,0,4096,150994944,4096,150994944,4096,150994944,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.18641e+06,569.49,1042.6
