...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1179.50 | 1631.32 | 98.3% | 89.4% |
| **API bench (installed)** | 1318.98 | 1458.81 | 109.9% | — |
| **hipblaslt-bench (stock)** | 1199.88 | 1603.61 | — | — |

> **Tuned/API ratio (gate metric):** 89.42%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 28672 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,28672,4096,1,8192,33554432,0,28672,117440512,8192,234881024,8192,234881024,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.19988e+06,448.208,1603.61
