...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1383.66 | 2085.93 | 114.1% | 98.6% |
| **API bench (installed)** | 1403.34 | 2056.68 | 115.7% | — |
| **hipblaslt-bench (stock)** | 1212.62 | 2380.16 | — | — |

> **Tuned/API ratio (gate metric):** 98.60%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 14336 -n 24576 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,14336,24576,4096,1,14336,58720256,0,4096,100663296,14336,352321536,14336,352321536,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.21262e+06,400.446,2380.16
