...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1435.54 | 8042.20 | 116.6% | 102.0% |
| **API bench (installed)** | 1407.21 | 8204.09 | 114.3% | — |
| **hipblaslt-bench (stock)** | 1231.39 | 9375.50 | — | — |

> **Tuned/API ratio (gate metric):** 102.01%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 49152 -k 28672 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,49152,28672,1,4096,117440512,0,28672,1409286144,4096,201326592,4096,201326592,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.23139e+06,343.315,9375.5
