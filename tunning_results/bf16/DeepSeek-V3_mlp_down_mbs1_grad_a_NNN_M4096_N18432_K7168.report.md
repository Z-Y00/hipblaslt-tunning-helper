...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1157.14 | 935.35 | 96.2% | 84.2% |
| **API bench (installed)** | 1374.44 | 787.47 | 114.3% | — |
| **hipblaslt-bench (stock)** | 1202.84 | 899.82 | — | — |

> **Tuned/API ratio (gate metric):** 84.19%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 18432 -n 4096 -k 7168 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,18432,4096,7168,1,18432,132120576,0,7168,29360128,18432,75497472,18432,75497472,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.20284e+06,490.552,899.816
