# Llama-3.1-405B — mlp_gate_up [grad_b]
...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1282.53 | 133739.00 | 120.2% | 100.2% |
| **API bench (installed)** | 1280.54 | 133946.57 | 120.0% | — |
| **hipblaslt-bench (stock)** | 1066.72 | 160796.00 | — | — |

> **Tuned/API ratio (gate metric):** 100.16%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 106496 -k 49152 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,106496,49152,1,16384,805306368,0,106496,5234491392,16384,1744830464,16384,1744830464,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.06672e+06,90.1766,160796
