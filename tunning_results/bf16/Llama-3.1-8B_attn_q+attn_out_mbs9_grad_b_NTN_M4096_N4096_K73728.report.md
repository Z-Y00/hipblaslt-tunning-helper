...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1398.62 | 1768.82 | 111.4% | 98.4% |
| **API bench (installed)** | 1421.67 | 1740.13 | 113.2% | — |
| **hipblaslt-bench (stock)** | 1255.37 | 1970.66 | — | — |

> **Tuned/API ratio (gate metric):** 98.38%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 4096 -k 73728 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,4096,73728,1,4096,301989888,0,4096,301989888,4096,16777216,4096,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.25537e+06,586.732,1970.66
