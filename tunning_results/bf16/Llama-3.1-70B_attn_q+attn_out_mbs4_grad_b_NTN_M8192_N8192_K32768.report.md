...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1236.86 | 3555.82 | 97.9% | 86.3% |
| **API bench (installed)** | 1432.51 | 3070.16 | 113.3% | — |
| **hipblaslt-bench (stock)** | 1263.97 | 3479.54 | — | — |

> **Tuned/API ratio (gate metric):** 86.34%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 8192 -k 32768 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,8192,32768,1,8192,268435456,0,8192,268435456,8192,67108864,8192,67108864,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.26397e+06,323.319,3479.54
