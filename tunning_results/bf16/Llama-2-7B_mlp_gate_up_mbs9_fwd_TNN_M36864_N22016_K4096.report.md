...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1296.20 | 5129.30 | 122.1% | 94.5% |
| **API bench (installed)** | 1372.25 | 4845.06 | 129.3% | — |
| **hipblaslt-bench (stock)** | 1061.18 | 6265.28 | — | — |

> **Tuned/API ratio (gate metric):** 94.46%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 22016 -n 36864 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,22016,36864,4096,1,4096,90177536,0,4096,150994944,22016,811597824,22016,811597824,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.06118e+06,312.985,6265.28
