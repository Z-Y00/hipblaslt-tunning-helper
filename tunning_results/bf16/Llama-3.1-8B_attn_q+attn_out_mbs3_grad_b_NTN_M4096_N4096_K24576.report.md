...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1342.73 | 614.15 | 112.3% | 98.7% |
| **API bench (installed)** | 1360.24 | 606.24 | 113.7% | — |
| **hipblaslt-bench (stock)** | 1196.06 | 689.46 | — | — |
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 4096 -k 24576 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 2240 --print_kernel_info
```
...
Rotating buffer 2240 MiB. Needed Size: 416 MiB. Needed block count: 1 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,4096,24576,1,4096,100663296,0,4096,100663296,4096,16777216,4096,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2240,0,0,1.19606e+06,589.229,689.46
