...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1259.89 | 218.18 | 112.2% | 101.6% |
| **API bench (installed)** | 1239.80 | 221.71 | 110.4% | — |
| **hipblaslt-bench (stock)** | 1123.33 | 244.70 | — | — |

> **Tuned/API ratio (gate metric):** 101.62%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,4096,8192,1,4096,33554432,0,4096,33554432,4096,16777216,4096,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,960,0,0,1.12333e+06,638.537,244.7
