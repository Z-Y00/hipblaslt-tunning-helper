...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1134.08 | 1893.60 | 97.9% | 86.5% |
| **API bench (installed)** | 1310.34 | 1638.88 | 113.1% | — |
| **hipblaslt-bench (stock)** | 1158.26 | 1854.06 | — | — |

> **Tuned/API ratio (gate metric):** 86.55%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 32000 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,32000,4096,1,8192,33554432,0,32000,131072000,8192,262144000,8192,262144000,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.15826e+06,428.747,1854.06
