...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1304.86 | 43816.50 | 112.3% | 97.5% |
| **API bench (installed)** | 1338.04 | 42730.19 | 115.1% | — |
| **hipblaslt-bench (stock)** | 1162.03 | 49202.50 | — | — |

> **Tuned/API ratio (gate metric):** 97.52%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 53248 -k 32768 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,53248,32768,1,16384,536870912,0,53248,1744830464,16384,872415232,16384,872415232,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.16203e+06,119.405,49202.5
