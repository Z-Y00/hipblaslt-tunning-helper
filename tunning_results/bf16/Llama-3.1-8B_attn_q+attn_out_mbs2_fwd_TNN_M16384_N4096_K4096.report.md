...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1381.18 | 398.03 | 110.6% | 101.8% |
| **API bench (installed)** | 1356.48 | 405.28 | 108.7% | — |
| **hipblaslt-bench (stock)** | 1248.42 | 440.36 | — | — |

> **Tuned/API ratio (gate metric):** 101.82%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,4096,16384,4096,1,4096,16777216,0,4096,67108864,4096,67108864,4096,67108864,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2080,0,0,1.24842e+06,638.682,440.36
