...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1331.25 | 75158.80 | 113.7% | 98.5% |
| **API bench (installed)** | 1350.95 | 74063.37 | 115.4% | — |
| **hipblaslt-bench (stock)** | 1170.37 | 85490.30 | — | — |

> **Tuned/API ratio (gate metric):** 98.54%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 57344 -k 53248 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,16384,57344,53248,1,16384,872415232,0,53248,3053453312,16384,939524096,16384,939524096,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.17037e+06,106.006,85490.3
