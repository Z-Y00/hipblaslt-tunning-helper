...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1351.21 | 7120.08 | 109.6% | 100.2% |
| **API bench (installed)** | 1348.53 | 7134.21 | 109.3% | — |
| **hipblaslt-bench (stock)** | 1233.34 | 7800.56 | — | — |

> **Tuned/API ratio (gate metric):** 100.20%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 20480 -k 28672 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,20480,28672,1,8192,234881024,0,28672,587202560,8192,167772160,8192,167772160,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.23334e+06,236.361,7800.56
