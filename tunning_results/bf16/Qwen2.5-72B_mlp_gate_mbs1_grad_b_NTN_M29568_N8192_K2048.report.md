...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1124.82 | 882.04 | 98.3% | 89.7% |
| **API bench (installed)** | 1253.55 | 791.46 | 109.6% | — |
| **hipblaslt-bench (stock)** | 1143.94 | 867.30 | — | — |

> **Tuned/API ratio (gate metric):** 89.73%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 29568 -k 2048 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,29568,2048,1,8192,16777216,0,29568,60555264,8192,242221056,8192,242221056,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.14394e+06,686.287,867.297
