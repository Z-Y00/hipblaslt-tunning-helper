...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 953.88 | 1936.13 | 117.0% | 144.2% |
| **API bench (installed)** | 661.63 | 2791.32 | 81.1% | — |
| **hipblaslt-bench (stock)** | 815.58 | 2264.46 | — | — |

> **Tuned/API ratio (gate metric):** 144.17%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 11008 -n 4096 -k 20480 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,11008,4096,20480,1,11008,225443840,0,4096,83886080,11008,45088768,11008,45088768,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,815575,291.529,2264.46
