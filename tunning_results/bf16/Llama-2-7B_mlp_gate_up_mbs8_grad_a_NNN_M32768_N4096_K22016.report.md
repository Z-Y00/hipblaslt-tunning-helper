...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1386.33 | 4262.98 | 123.9% | 113.4% |
| **API bench (installed)** | 1222.88 | 4832.75 | 109.2% | — |
| **hipblaslt-bench (stock)** | 1119.36 | 5279.68 | — | — |

> **Tuned/API ratio (gate metric):** 113.37%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 32768 -k 22016 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,32768,22016,1,4096,90177536,0,22016,721420288,4096,134217728,4096,134217728,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.11936e+06,333.679,5279.68
