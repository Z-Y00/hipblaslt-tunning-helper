...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 975.97 | 70.41 | 131.7% | 110.6% |
| **API bench (installed)** | 882.71 | 77.85 | 119.1% | — |
| **hipblaslt-bench (stock)** | 741.15 | 92.72 | — | — |

> **Tuned/API ratio (gate metric):** 110.57%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 8192 -k 1024 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 950 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
Rotating buffer 950 MiB. Needed Size: 88 MiB. Needed block count: 11 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,8192,1024,1,4096,4194304,0,1024,8388608,4096,33554432,4096,33554432,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,950,1,1,741148,926.846,92.7203
