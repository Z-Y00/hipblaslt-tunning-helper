...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1086.01 | 2055.52 | 100.0% | 91.0% |
| **API bench (installed)** | 1192.82 | 1871.46 | 109.8% | — |
| **hipblaslt-bench (stock)** | 1086.04 | 2055.45 | — | — |

> **Tuned/API ratio (gate metric):** 91.05%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 3584 -n 152064 -k 2048 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,3584,152064,2048,1,3584,7340032,0,152064,311427072,3584,544997376,3584,544997376,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.08604e+06,782.741,2055.45
