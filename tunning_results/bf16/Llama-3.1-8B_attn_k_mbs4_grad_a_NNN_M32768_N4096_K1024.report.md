...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1045.25 | 262.98 | 109.3% | 98.4% |
| **API bench (installed)** | 1062.34 | 258.75 | 111.1% | — |
| **hipblaslt-bench (stock)** | 956.56 | 287.36 | — | — |

> **Tuned/API ratio (gate metric):** 98.39%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 32768 -k 1024 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,32768,1024,1,4096,4194304,0,1024,33554432,4096,134217728,4096,134217728,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,956563,1114.67,287.36
