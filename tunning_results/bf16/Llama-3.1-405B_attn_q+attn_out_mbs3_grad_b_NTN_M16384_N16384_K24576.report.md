...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1338.22 | 9859.47 | 112.0% | 99.4% |
| **API bench (installed)** | 1346.05 | 9802.12 | 112.6% | — |
| **hipblaslt-bench (stock)** | 1195.34 | 11038.00 | — | — |

> **Tuned/API ratio (gate metric):** 99.42%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 16384 -k 24576 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,16384,24576,1,16384,402653184,0,16384,402653184,16384,268435456,16384,268435456,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.19534e+06,181.193,11038
