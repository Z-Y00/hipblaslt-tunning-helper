...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1367.47 | 5628.34 | 131.7% | 110.8% |
| **API bench (installed)** | 1234.36 | 6235.27 | 118.9% | — |
| **hipblaslt-bench (stock)** | 1038.02 | 7414.68 | — | — |

> **Tuned/API ratio (gate metric):** 110.78%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 14336 -n 65536 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,14336,65536,4096,1,14336,58720256,0,4096,268435456,14336,939524096,14336,939524096,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.03802e+06,318.203,7414.68
