...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1398.31 | 10615.30 | 112.0% | 101.3% |
| **API bench (installed)** | 1380.83 | 10749.66 | 110.6% | — |
| **hipblaslt-bench (stock)** | 1248.60 | 11888.00 | — | — |

> **Tuned/API ratio (gate metric):** 101.27%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 24576 -k 18432 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,16384,24576,18432,1,16384,301989888,0,18432,452984832,16384,402653184,16384,402653184,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.2486e+06,181.38,11888
