...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1435.21 | 861.86 | 114.3% | 98.9% |
| **API bench (installed)** | 1451.60 | 852.13 | 115.6% | — |
| **hipblaslt-bench (stock)** | 1256.20 | 984.68 | — | — |

> **Tuned/API ratio (gate metric):** 98.87%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 12288 -k 12288 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,12288,12288,1,4096,50331648,0,12288,150994944,4096,50331648,4096,50331648,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.2562e+06,476.043,984.68
