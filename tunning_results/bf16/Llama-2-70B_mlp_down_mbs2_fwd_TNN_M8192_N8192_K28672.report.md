...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1440.80 | 2670.94 | 110.8% | 97.1% |
| **API bench (installed)** | 1483.50 | 2594.07 | 114.1% | — |
| **hipblaslt-bench (stock)** | 1300.53 | 2959.02 | — | — |

> **Tuned/API ratio (gate metric):** 97.12%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,8192,8192,28672,1,28672,234881024,0,28672,234881024,8192,67108864,8192,67108864,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.30053e+06,337.95,2959.02
