...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1308.82 | 21842.10 | 121.3% | 106.2% |
| **API bench (installed)** | 1232.43 | 23195.91 | 114.3% | — |
| **hipblaslt-bench (stock)** | 1078.60 | 26504.20 | — | — |

> **Tuned/API ratio (gate metric):** 106.20%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 106496 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,106496,8192,1,16384,134217728,0,106496,872415232,16384,1744830464,16384,1744830464,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.0786e+06,193.366,26504.2
