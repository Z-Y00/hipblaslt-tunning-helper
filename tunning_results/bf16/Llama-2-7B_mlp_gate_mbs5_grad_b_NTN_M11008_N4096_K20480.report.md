...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1345.57 | 1372.53 | 116.2% | 102.4% |
| **API bench (installed)** | 1314.32 | 1405.16 | 113.5% | — |
| **hipblaslt-bench (stock)** | 1157.57 | 1595.44 | — | — |

> **Tuned/API ratio (gate metric):** 102.38%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 11008 -k 20480 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,11008,20480,1,4096,83886080,0,11008,225443840,4096,45088768,4096,45088768,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.15757e+06,413.777,1595.44
