...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1295.47 | 285.12 | 163.6% | 149.8% |
| **API bench (installed)** | 864.64 | 427.19 | 109.2% | — |
| **hipblaslt-bench (stock)** | 791.92 | 466.42 | — | — |

> **Tuned/API ratio (gate metric):** 149.83%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 4096 -k 11008 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 1180 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,4096,11008,1,4096,45088768,0,11008,45088768,4096,16777216,4096,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1180,0,0,791920,427.123,466.42
