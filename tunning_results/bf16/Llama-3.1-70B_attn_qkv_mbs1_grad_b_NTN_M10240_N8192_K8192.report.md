...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1218.15 | 1128.26 | 98.1% | 86.1% |
| **API bench (installed)** | 1414.74 | 971.48 | 114.0% | — |
| **hipblaslt-bench (stock)** | 1241.49 | 1107.05 | — | — |

> **Tuned/API ratio (gate metric):** 86.10%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 10240 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,10240,8192,1,8192,67108864,0,10240,83886080,8192,83886080,8192,83886080,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.24149e+06,395.194,1107.05
