...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1354.07 | 1421.00 | 112.0% | 107.3% |
| **API bench (installed)** | 1261.50 | 1525.29 | 104.4% | — |
| **hipblaslt-bench (stock)** | 1208.74 | 1591.86 | — | — |

> **Tuned/API ratio (gate metric):** 107.34%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 4096 -k 57344 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,4096,57344,1,4096,234881024,0,4096,234881024,4096,16777216,4096,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.20874e+06,569.303,1591.86
