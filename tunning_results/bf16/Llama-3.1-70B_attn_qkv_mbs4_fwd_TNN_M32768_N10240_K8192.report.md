...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1419.10 | 3873.97 | 112.8% | 106.4% |
| **API bench (installed)** | 1334.32 | 4120.11 | 106.0% | — |
| **hipblaslt-bench (stock)** | 1258.54 | 4368.20 | — | — |

> **Tuned/API ratio (gate metric):** 106.35%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,10240,32768,8192,1,8192,83886080,0,8192,268435456,10240,335544320,10240,335544320,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.25854e+06,293.313,4368.2
