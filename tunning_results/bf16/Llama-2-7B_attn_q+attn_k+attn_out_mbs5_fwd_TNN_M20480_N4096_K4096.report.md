...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1391.67 | 493.79 | 112.2% | 96.3% |
| **API bench (installed)** | 1444.71 | 475.66 | 116.5% | — |
| **hipblaslt-bench (stock)** | 1240.20 | 554.10 | — | — |

> **Tuned/API ratio (gate metric):** 96.33%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 20480 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,4096,20480,4096,1,4096,16777216,0,4096,83886080,4096,83886080,4096,83886080,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.2402e+06,620.375,554.1
