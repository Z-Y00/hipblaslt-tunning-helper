...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1332.22 | 1109.03 | 175.3% | 154.6% |
| **API bench (installed)** | 861.67 | 1714.65 | 113.4% | — |
| **hipblaslt-bench (stock)** | 759.87 | 1944.36 | — | — |

> **Tuned/API ratio (gate metric):** 154.61%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 22016 -n 8192 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,22016,8192,4096,1,4096,90177536,0,4096,33554432,22016,180355072,22016,180355072,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,759874,291.307,1944.36
