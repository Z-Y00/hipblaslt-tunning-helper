...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1393.62 | 2761.36 | 109.7% | 96.1% |
| **API bench (installed)** | 1450.31 | 2653.42 | 114.2% | — |
| **hipblaslt-bench (stock)** | 1270.38 | 3029.24 | — | — |

> **Tuned/API ratio (gate metric):** 96.09%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,28672,8192,8192,1,28672,234881024,0,8192,67108864,28672,234881024,28672,234881024,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.27038e+06,330.116,3029.24
