...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1278.55 | 27088.90 | 114.7% | 96.9% |
| **API bench (installed)** | 1319.08 | 26256.74 | 118.3% | — |
| **hipblaslt-bench (stock)** | 1114.57 | 31074.50 | — | — |

> **Tuned/API ratio (gate metric):** 96.93%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 57344 -k 36864 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,57344,36864,1,8192,301989888,0,57344,2113929216,8192,469762048,8192,469762048,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.11457e+06,172.971,31074.5
