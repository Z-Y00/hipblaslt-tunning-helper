...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1304.47 | 1264.32 | 136.2% | 121.6% |
| **API bench (installed)** | 1072.36 | 1537.98 | 112.0% | — |
| **hipblaslt-bench (stock)** | 957.77 | 1721.98 | — | — |

> **Tuned/API ratio (gate metric):** 121.64%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 6144 -k 32768 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,6144,32768,1,4096,134217728,0,6144,201326592,4096,25165824,4096,25165824,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,957774,390.176,1721.98
