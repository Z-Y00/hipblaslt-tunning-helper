...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1068.72 | 192.90 | 142.8% | 132.3% |
| **API bench (installed)** | 807.97 | 255.16 | 108.0% | — |
| **hipblaslt-bench (stock)** | 748.41 | 275.46 | — | — |

> **Tuned/API ratio (gate metric):** 132.27%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 1024 -k 24576 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 1280 --print_kernel_info
```
...
Rotating buffer 1280 MiB. Needed Size: 248 MiB. Needed block count: 6 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,1024,24576,1,4096,100663296,0,1024,25165824,4096,4194304,4096,4194304,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1280,0,0,748415,879.211,275.46
