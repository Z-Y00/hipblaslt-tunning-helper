...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1416.45 | 1358.43 | 113.6% | 97.4% |
| **API bench (installed)** | 1455.01 | 1322.43 | 116.7% | — |
| **hipblaslt-bench (stock)** | 1246.72 | 1543.36 | — | — |

> **Tuned/API ratio (gate metric):** 97.35%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 14336 -n 16384 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,14336,16384,4096,1,4096,58720256,0,4096,67108864,14336,234881024,14336,234881024,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.24672e+06,435.333,1543.36
