...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1236.95 | 27833.30 | 97.7% | 87.3% |
| **API bench (installed)** | 1416.72 | 24301.50 | 111.9% | — |
| **hipblaslt-bench (stock)** | 1266.62 | 27181.40 | — | — |

> **Tuned/API ratio (gate metric):** 87.31%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 8192 -k 128256 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,16384,8192,128256,1,16384,2101346304,0,128256,1050673152,16384,134217728,16384,134217728,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.26662e+06,225.194,27181.4
