...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1315.54 | 4387.90 | 121.7% | 106.3% |
| **API bench (installed)** | 1237.83 | 4663.34 | 114.5% | — |
| **hipblaslt-bench (stock)** | 1081.17 | 5339.04 | — | — |

> **Tuned/API ratio (gate metric):** 106.28%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 28672 -n 12288 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,28672,12288,8192,1,28672,234881024,0,8192,100663296,28672,352321536,28672,352321536,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.08117e+06,239.978,5339.04
