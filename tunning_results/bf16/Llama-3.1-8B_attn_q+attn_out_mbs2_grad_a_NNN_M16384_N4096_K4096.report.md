...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1342.84 | 409.40 | 110.6% | 101.1% |
| **API bench (installed)** | 1328.88 | 413.70 | 109.5% | — |
| **hipblaslt-bench (stock)** | 1213.70 | 452.96 | — | — |

> **Tuned/API ratio (gate metric):** 101.05%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,16384,4096,1,4096,16777216,0,4096,67108864,4096,67108864,4096,67108864,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2080,0,0,1.2137e+06,620.916,452.96
