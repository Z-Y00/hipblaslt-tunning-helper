...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1027.81 | 468.02 | 315.4% | 298.0% |
| **API bench (installed)** | 344.95 | 1394.50 | 105.9% | — |
| **hipblaslt-bench (stock)** | 325.83 | 1476.32 | — | — |

> **Tuned/API ratio (gate metric):** 297.96%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 28672 -k 1024 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,28672,1024,1,8192,8388608,0,1024,29360128,8192,234881024,8192,234881024,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,325835,343.972,1476.32
