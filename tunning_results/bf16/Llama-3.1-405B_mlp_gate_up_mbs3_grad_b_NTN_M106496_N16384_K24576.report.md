...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1257.27 | 68212.60 | 117.5% | 97.6% |
| **API bench (installed)** | 1288.17 | 66576.30 | 120.3% | — |
| **hipblaslt-bench (stock)** | 1070.47 | 80116.50 | — | — |

> **Tuned/API ratio (gate metric):** 97.60%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 106496 -k 24576 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,106496,24576,1,16384,402653184,0,106496,2617245696,16384,1744830464,16384,1744830464,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.07047e+06,110.776,80116.5
