...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1380.44 | 51772.10 | 111.4% | 99.7% |
| **API bench (installed)** | 1383.94 | 51641.24 | 111.7% | — |
| **hipblaslt-bench (stock)** | 1238.82 | 57690.50 | — | — |

> **Tuned/API ratio (gate metric):** 99.75%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 53248 -n 40960 -k 16384 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,53248,40960,16384,1,16384,872415232,0,16384,671088640,53248,2181038080,53248,2181038080,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.23882e+06,120.254,57690.5
