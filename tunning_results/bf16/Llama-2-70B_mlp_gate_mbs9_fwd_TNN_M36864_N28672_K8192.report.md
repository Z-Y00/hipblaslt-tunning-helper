...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1328.71 | 13033.20 | 110.0% | 97.1% |
| **API bench (installed)** | 1368.51 | 12654.18 | 113.3% | — |
| **hipblaslt-bench (stock)** | 1207.95 | 14336.10 | — | — |

> **Tuned/API ratio (gate metric):** 97.09%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 28672 -n 36864 -k 8192 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,28672,36864,8192,1,8192,234881024,0,8192,301989888,28672,1056964608,28672,1056964608,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.20795e+06,207.082,14336.1
