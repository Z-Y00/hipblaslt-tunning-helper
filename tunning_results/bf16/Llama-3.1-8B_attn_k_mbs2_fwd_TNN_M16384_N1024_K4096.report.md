...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1214.29 | 113.19 | 938.7% | 26965.0% |
| **API bench (installed)** | 4.50 | 30520.39 | 3.5% | — |
| **hipblaslt-bench (stock)** | 129.36 | 1062.48 | — | — |

> **Tuned/API ratio (gate metric):** 26965.05%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 1024 -n 16384 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 1000 --print_kernel_info
```
...
Rotating buffer 1000 MiB. Needed Size: 168 MiB. Needed block count: 6 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,1024,16384,4096,1,4096,4194304,0,4096,67108864,1024,16777216,1024,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1000,0,0,129357,154.415,1062.48
