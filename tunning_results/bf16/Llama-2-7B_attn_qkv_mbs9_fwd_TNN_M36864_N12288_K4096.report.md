...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1420.41 | 2612.52 | 248.5% | 211.7% |
| **API bench (installed)** | 671.03 | 5530.07 | 117.4% | — |
| **hipblaslt-bench (stock)** | 571.48 | 6493.38 | — | — |

> **Tuned/API ratio (gate metric):** 211.68%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 12288 -n 36864 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,12288,36864,4096,1,4096,50331648,0,4096,150994944,12288,452984832,12288,452984832,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,571482,187.691,6493.38
