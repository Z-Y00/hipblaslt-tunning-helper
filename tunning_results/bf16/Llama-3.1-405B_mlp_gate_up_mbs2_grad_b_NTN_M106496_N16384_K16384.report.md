...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1313.22 | 43537.90 | 113.0% | 107.6% |
| **API bench (installed)** | 1220.03 | 46863.45 | 104.9% | — |
| **hipblaslt-bench (stock)** | 1162.49 | 49182.90 | — | — |

> **Tuned/API ratio (gate metric):** 107.64%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 106496 -k 16384 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,106496,16384,1,16384,268435456,0,106496,1744830464,16384,1744830464,16384,1744830464,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.16249e+06,142.326,49182.9
