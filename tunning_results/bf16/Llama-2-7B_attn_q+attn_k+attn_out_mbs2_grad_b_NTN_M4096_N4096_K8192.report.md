...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1273.88 | 215.78 | 126.5% | 98.5% |
| **API bench (installed)** | 1293.70 | 212.47 | 128.5% | — |
| **hipblaslt-bench (stock)** | 1007.10 | 272.94 | — | — |

> **Tuned/API ratio (gate metric):** 98.47%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 4096 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 960 --print_kernel_info
```
...
Rotating buffer 960 MiB. Needed Size: 160 MiB. Needed block count: 6 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,4096,8192,1,4096,33554432,0,4096,33554432,4096,16777216,4096,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,960,0,0,1.0071e+06,572.47,272.94
