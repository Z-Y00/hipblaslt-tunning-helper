# Llama-2-70B — mlp_gate_up [grad_a]
...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1422.77 | 24343.10 | 119.7% | 109.8% |
| **API bench (installed)** | 1296.37 | 26716.69 | 109.0% | — |
| **hipblaslt-bench (stock)** | 1189.04 | 29128.20 | — | — |

> **Tuned/API ratio (gate metric):** 109.75%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 36864 -k 57344 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,36864,57344,1,8192,469762048,0,57344,2113929216,8192,301989888,8192,301989888,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.18904e+06,184.529,29128.2
