...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1321.11 | 108194.00 | 110.7% | 97.8% |
| **API bench (installed)** | 1350.34 | 105852.24 | 113.1% | — |
| **hipblaslt-bench (stock)** | 1193.94 | 119718.00 | — | — |

> **Tuned/API ratio (gate metric):** 97.84%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 106496 -n 40960 -k 16384 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,106496,40960,16384,1,16384,1744830464,0,16384,671088640,106496,4362076160,106496,4362076160,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.19394e+06,105.456,119718
