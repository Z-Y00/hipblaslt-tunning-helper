...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1024.24 | 536.75 | 297.0% | 313.1% |
| **API bench (installed)** | 327.09 | 1680.75 | 94.8% | — |
| **hipblaslt-bench (stock)** | 344.91 | 1593.92 | — | — |

> **Tuned/API ratio (gate metric):** 313.14%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,32768,1024,1,8192,8388608,0,1024,33554432,8192,268435456,8192,268435456,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,344908,362.706,1593.92
