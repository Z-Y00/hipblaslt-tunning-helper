...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1321.73 | 4367.34 | 109.8% | 97.8% |
| **API bench (installed)** | 1351.60 | 4270.81 | 112.3% | — |
| **hipblaslt-bench (stock)** | 1203.66 | 4795.74 | — | — |

> **Tuned/API ratio (gate metric):** 97.79%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 14336 -k 49152 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,14336,49152,1,4096,201326592,0,14336,704643072,4096,58720256,4096,58720256,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.20366e+06,374.681,4795.74
