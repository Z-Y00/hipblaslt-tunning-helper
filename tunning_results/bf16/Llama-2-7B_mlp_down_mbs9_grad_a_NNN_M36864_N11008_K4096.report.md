...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1367.98 | 2430.09 | 144.7% | 160.2% |
| **API bench (installed)** | 853.67 | 3894.15 | 90.3% | — |
| **hipblaslt-bench (stock)** | 945.14 | 3517.26 | — | — |

> **Tuned/API ratio (gate metric):** 160.25%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 11008 -n 36864 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,11008,36864,4096,1,11008,45088768,0,4096,150994944,11008,405798912,11008,405798912,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,945140,318.741,3517.26
