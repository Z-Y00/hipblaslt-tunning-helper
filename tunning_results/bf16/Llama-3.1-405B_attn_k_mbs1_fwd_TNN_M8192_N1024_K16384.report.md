...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1226.17 | 224.18 | 122.6% | 112.8% |
| **API bench (installed)** | 1087.28 | 252.81 | 108.7% | — |
| **hipblaslt-bench (stock)** | 1000.50 | 274.74 | — | — |

> **Tuned/API ratio (gate metric):** 112.77%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 1024 -n 8192 -k 16384 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 1600 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,1024,8192,16384,1,16384,16777216,0,16384,134217728,1024,8388608,1024,8388608,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1600,0,0,1.0005e+06,1080.57,274.74
