...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1321.18 | 416.11 | 113.1% | 99.8% |
| **API bench (installed)** | 1323.43 | 415.40 | 113.3% | — |
| **hipblaslt-bench (stock)** | 1168.10 | 470.64 | — | — |

> **Tuned/API ratio (gate metric):** 99.83%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,4096,16384,1,4096,67108864,0,4096,67108864,4096,16777216,4096,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1600,0,0,1.1681e+06,597.591,470.64
