...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1320.77 | 32466.70 | 114.0% | 99.5% |
| **API bench (installed)** | 1327.04 | 32313.32 | 114.5% | — |
| **hipblaslt-bench (stock)** | 1158.53 | 37013.10 | — | — |

> **Tuned/API ratio (gate metric):** 99.53%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 53248 -k 24576 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,53248,24576,1,16384,402653184,0,53248,1308622848,16384,872415232,16384,872415232,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.15853e+06,130.021,37013.1
