...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1347.54 | 2753.79 | 106.6% | 92.8% |
| **API bench (installed)** | 1451.35 | 2556.83 | 114.8% | — |
| **hipblaslt-bench (stock)** | 1263.78 | 2936.30 | — | — |

> **Tuned/API ratio (gate metric):** 92.85%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 6144 -n 73728 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,6144,73728,4096,1,4096,25165824,0,4096,301989888,6144,452984832,6144,452984832,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.26378e+06,494.883,2936.3
