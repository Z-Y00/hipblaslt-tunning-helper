...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1410.86 | 2727.62 | 116.1% | 101.1% |
| **API bench (installed)** | 1395.75 | 2757.15 | 114.8% | — |
| **hipblaslt-bench (stock)** | 1215.59 | 3165.78 | — | — |

> **Tuned/API ratio (gate metric):** 101.08%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,28672,8192,1,8192,67108864,0,28672,234881024,8192,234881024,8192,234881024,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.21559e+06,315.878,3165.78
