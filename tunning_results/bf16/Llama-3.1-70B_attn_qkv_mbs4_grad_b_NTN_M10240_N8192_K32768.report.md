...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1231.24 | 4465.05 | 98.6% | 89.1% |
| **API bench (installed)** | 1381.65 | 3978.99 | 110.7% | — |
| **hipblaslt-bench (stock)** | 1248.28 | 4404.12 | — | — |

> **Tuned/API ratio (gate metric):** 89.11%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 10240 -k 32768 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,10240,32768,1,8192,268435456,0,10240,335544320,8192,83886080,8192,83886080,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.24828e+06,290.921,4404.12
