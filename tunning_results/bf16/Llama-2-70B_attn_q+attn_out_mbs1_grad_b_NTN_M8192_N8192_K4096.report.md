...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1284.19 | 428.09 | 111.8% | 96.1% |
| **API bench (installed)** | 1336.94 | 411.20 | 116.4% | — |
| **hipblaslt-bench (stock)** | 1148.87 | 478.52 | — | — |

> **Tuned/API ratio (gate metric):** 96.05%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 8192 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 1920 --print_kernel_info
```
...
Rotating buffer 1920 MiB. Needed Size: 256 MiB. Needed block count: 8 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,8192,8192,4096,1,8192,33554432,0,8192,33554432,8192,67108864,8192,67108864,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1920,0,0,1.14887e+06,522.444,478.52
