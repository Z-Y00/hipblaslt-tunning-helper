...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1153.89 | 1667.53 | 97.4% | 88.8% |
| **API bench (installed)** | 1299.02 | 1481.22 | 109.6% | — |
| **hipblaslt-bench (stock)** | 1185.22 | 1623.46 | — | — |

> **Tuned/API ratio (gate metric):** 88.83%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 28672 -n 8192 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,28672,8192,4096,1,28672,117440512,0,8192,33554432,28672,234881024,28672,234881024,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.18522e+06,442.728,1623.46
