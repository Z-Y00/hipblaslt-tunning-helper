...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1411.58 | 1363.12 | 111.6% | 111.6% |
| **API bench (installed)** | 1264.74 | 1521.38 | 100.0% | — |
| **hipblaslt-bench (stock)** | 1265.22 | 1520.80 | — | — |

> **Tuned/API ratio (gate metric):** 111.61%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 16384 -k 14336 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,4096,16384,14336,1,14336,58720256,0,14336,234881024,4096,67108864,4096,67108864,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.26522e+06,441.791,1520.8
