...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1225.16 | 3589.76 | 97.3% | 83.8% |
| **API bench (installed)** | 1462.72 | 3006.75 | 116.1% | — |
| **hipblaslt-bench (stock)** | 1259.35 | 3492.30 | — | — |

> **Tuned/API ratio (gate metric):** 83.76%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 32768 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,32768,8192,1,8192,67108864,0,8192,268435456,8192,268435456,8192,268435456,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.25935e+06,322.137,3492.3
