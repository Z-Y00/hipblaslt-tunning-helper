...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1331.89 | 1663.96 | 110.6% | 97.2% |
| **API bench (installed)** | 1370.88 | 1616.63 | 113.9% | — |
| **hipblaslt-bench (stock)** | 1203.90 | 1840.86 | — | — |

> **Tuned/API ratio (gate metric):** 97.16%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 11008 -n 4096 -k 24576 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,11008,4096,24576,1,11008,270532608,0,4096,100663296,11008,45088768,11008,45088768,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.2039e+06,421.211,1840.86
