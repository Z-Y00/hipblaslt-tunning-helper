# Llama-3.1-405B — attn_q+attn_out [grad_a]
...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1388.94 | 25331.80 | 126.2% | 106.7% |
| **API bench (installed)** | 1302.20 | 27019.15 | 118.3% | — |
| **hipblaslt-bench (stock)** | 1100.53 | 31970.50 | — | — |

> **Tuned/API ratio (gate metric):** 106.66%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 65536 -k 16384 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,16384,65536,16384,1,16384,268435456,0,16384,1073741824,16384,1073741824,16384,1073741824,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.10053e+06,140.755,31970.5
