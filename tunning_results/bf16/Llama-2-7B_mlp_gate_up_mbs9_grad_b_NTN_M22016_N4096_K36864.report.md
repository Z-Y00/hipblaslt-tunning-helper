...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1266.69 | 5248.80 | 121.3% | 106.4% |
| **API bench (installed)** | 1190.30 | 5585.64 | 113.9% | — |
| **hipblaslt-bench (stock)** | 1044.61 | 6364.68 | — | — |

> **Tuned/API ratio (gate metric):** 106.42%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 22016 -k 36864 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,22016,36864,1,4096,150994944,0,22016,811597824,4096,90177536,4096,90177536,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.04461e+06,308.097,6364.68
