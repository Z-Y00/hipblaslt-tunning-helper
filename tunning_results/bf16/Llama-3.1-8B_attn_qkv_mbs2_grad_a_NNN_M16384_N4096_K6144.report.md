...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1371.27 | 601.36 | 113.2% | 100.7% |
| **API bench (installed)** | 1361.79 | 605.55 | 112.4% | — |
| **hipblaslt-bench (stock)** | 1211.02 | 680.94 | — | — |

> **Tuned/API ratio (gate metric):** 100.70%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 16384 -k 6144 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 2480 --print_kernel_info
```
...
Rotating buffer 2480 MiB. Needed Size: 368 MiB. Needed block count: 1 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,16384,6144,1,4096,25165824,0,6144,100663296,4096,67108864,4096,67108864,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2480,0,0,1.21102e+06,527.763,680.94
