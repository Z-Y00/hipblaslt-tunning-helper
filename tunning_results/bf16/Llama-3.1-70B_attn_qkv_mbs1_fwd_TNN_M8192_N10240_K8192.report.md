...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1290.53 | 1064.98 | 101.2% | 87.5% |
| **API bench (installed)** | 1474.88 | 931.87 | 115.6% | — |
| **hipblaslt-bench (stock)** | 1275.77 | 1077.30 | — | — |

> **Tuned/API ratio (gate metric):** 87.50%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,10240,8192,8192,1,8192,83886080,0,8192,67108864,10240,83886080,10240,83886080,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.27577e+06,406.106,1077.3
