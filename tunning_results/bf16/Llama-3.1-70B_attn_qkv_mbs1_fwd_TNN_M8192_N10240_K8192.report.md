...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1387.61 | 990.47 | 111.0% | 95.9% |
| **API bench (installed)** | 1446.49 | 950.16 | 115.7% | — |
| **hipblaslt-bench (stock)** | 1250.06 | 1099.46 | — | — |

> **Tuned/API ratio (gate metric):** 95.93%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,10240,8192,8192,1,8192,83886080,0,8192,67108864,10240,83886080,10240,83886080,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.25006e+06,397.923,1099.46
