...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1379.35 | 25109.40 | 180.5% | 157.8% |
| **API bench (installed)** | 874.33 | 39612.64 | 114.4% | — |
| **hipblaslt-bench (stock)** | 764.19 | 45321.90 | — | — |

> **Tuned/API ratio (gate metric):** 157.76%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 57344 -n 36864 -k 8192 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,57344,36864,8192,1,8192,469762048,0,8192,301989888,57344,2113929216,57344,2113929216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,764192,118.596,45321.9
