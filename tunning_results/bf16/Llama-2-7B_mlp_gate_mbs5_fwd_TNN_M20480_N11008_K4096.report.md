...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1395.42 | 1323.50 | 118.6% | 103.2% |
| **API bench (installed)** | 1351.58 | 1366.43 | 114.8% | — |
| **hipblaslt-bench (stock)** | 1177.05 | 1569.04 | — | — |

> **Tuned/API ratio (gate metric):** 103.24%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 11008 -n 20480 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,11008,20480,4096,1,4096,45088768,0,4096,83886080,11008,225443840,11008,225443840,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.17705e+06,420.739,1569.04
