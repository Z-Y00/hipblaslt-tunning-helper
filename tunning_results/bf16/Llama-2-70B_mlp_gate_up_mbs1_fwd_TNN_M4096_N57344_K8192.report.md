...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1415.60 | 2718.50 | 135.6% | 123.8% |
| **API bench (installed)** | 1143.26 | 3366.05 | 109.5% | — |
| **hipblaslt-bench (stock)** | 1044.26 | 3685.18 | — | — |

> **Tuned/API ratio (gate metric):** 123.82%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 57344 -n 4096 -k 8192 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,57344,4096,8192,1,8192,469762048,0,8192,33554432,57344,234881024,57344,234881024,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.04426e+06,373.116,3685.18
