...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1192.51 | 461.01 | 604.4% | 5313.6% |
| **API bench (installed)** | 22.44 | 24496.00 | 11.4% | — |
| **hipblaslt-bench (stock)** | 197.32 | 2786.14 | — | — |

> **Tuned/API ratio (gate metric):** 5313.58%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 1024 -k 16384 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,1024,16384,1,16384,268435456,0,1024,16777216,16384,16777216,16384,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,197318,201.892,2786.14
