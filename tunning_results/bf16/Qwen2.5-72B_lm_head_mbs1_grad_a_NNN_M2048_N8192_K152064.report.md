...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1273.47 | 4006.69 | 101.5% | 90.4% |
| **API bench (installed)** | 1409.47 | 3620.09 | 112.3% | — |
| **hipblaslt-bench (stock)** | 1254.64 | 4066.84 | — | — |

> **Tuned/API ratio (gate metric):** 90.35%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 2048 -k 152064 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,2048,152064,1,8192,1245708288,0,152064,311427072,8192,16777216,8192,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.25464e+06,720.865,4066.84
