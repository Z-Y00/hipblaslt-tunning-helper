...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1330.62 | 26442.00 | 114.9% | 99.0% |
| **API bench (installed)** | 1344.69 | 26165.42 | 116.1% | — |
| **hipblaslt-bench (stock)** | 1158.24 | 30377.50 | — | — |

> **Tuned/API ratio (gate metric):** 98.95%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 16384 -k 65536 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,16384,65536,1,16384,1073741824,0,16384,1073741824,16384,268435456,16384,268435456,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.15824e+06,148.136,30377.5
