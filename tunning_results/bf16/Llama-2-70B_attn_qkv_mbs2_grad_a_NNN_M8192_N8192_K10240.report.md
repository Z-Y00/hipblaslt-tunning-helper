...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1350.68 | 1017.55 | 110.9% | 98.1% |
| **API bench (installed)** | 1376.89 | 998.19 | 113.0% | — |
| **hipblaslt-bench (stock)** | 1218.00 | 1128.40 | — | — |

> **Tuned/API ratio (gate metric):** 98.10%
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,8192,10240,1,8192,83886080,0,10240,83886080,8192,67108864,8192,67108864,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.218e+06,387.717,1128.4
