...
| **API bench (installed)** | 1228.76 | 300.60 | 111.2% | — |
| **hipblaslt-bench (stock)** | 1105.04 | 334.25 | — | — |
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 11008 -n 4096 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 1813 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
Rotating buffer 1813 MiB. Needed Size: 204 MiB. Needed block count: 9 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,11008,4096,4096,1,4096,45088768,0,4096,16777216,11008,45088768,11008,45088768,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1813,1,1,1.10504e+06,596.008,334.255
