...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1420.02 | 12195.10 | 111.2% | 100.0% |
| **API bench (installed)** | 1420.36 | 12192.23 | 111.2% | — |
| **hipblaslt-bench (stock)** | 1277.56 | 13555.00 | — | — |

> **Tuned/API ratio (gate metric):** 99.98%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 36864 -k 28672 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,8192,36864,28672,1,28672,234881024,0,28672,1056964608,8192,301989888,8192,301989888,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.27756e+06,219.015,13555
