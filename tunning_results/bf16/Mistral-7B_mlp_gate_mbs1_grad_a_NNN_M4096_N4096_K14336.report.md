...
| **API bench (installed)** | 1359.81 | 353.75 | 113.8% | — |
| **hipblaslt-bench (stock)** | 1194.68 | 402.65 | — | — |
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 4096 -k 14336 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 1800 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
Rotating buffer 1800 MiB. Needed Size: 256 MiB. Needed block count: 8 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,4096,14336,1,4096,58720256,0,14336,58720256,4096,16777216,4096,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1800,1,1,1.19468e+06,620.89,402.648
