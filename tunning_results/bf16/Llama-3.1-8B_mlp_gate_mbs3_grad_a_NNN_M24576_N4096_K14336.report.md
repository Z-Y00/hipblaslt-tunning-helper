...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1362.62 | 2118.14 | 111.2% | 98.6% |
| **API bench (installed)** | 1381.84 | 2088.68 | 112.8% | — |
| **hipblaslt-bench (stock)** | 1224.87 | 2356.34 | — | — |

> **Tuned/API ratio (gate metric):** 98.61%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 24576 -k 14336 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,24576,14336,1,4096,58720256,0,14336,352321536,4096,100663296,4096,100663296,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.22487e+06,404.494,2356.34
