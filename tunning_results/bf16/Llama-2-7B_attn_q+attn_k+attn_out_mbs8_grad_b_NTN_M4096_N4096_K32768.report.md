...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1422.12 | 773.15 | 114.2% | 99.3% |
| **API bench (installed)** | 1432.72 | 767.43 | 115.0% | — |
| **hipblaslt-bench (stock)** | 1245.82 | 882.56 | — | — |

> **Tuned/API ratio (gate metric):** 99.26%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 4096 -k 32768 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,4096,32768,1,4096,134217728,0,4096,134217728,4096,16777216,4096,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.24582e+06,601.942,882.56
