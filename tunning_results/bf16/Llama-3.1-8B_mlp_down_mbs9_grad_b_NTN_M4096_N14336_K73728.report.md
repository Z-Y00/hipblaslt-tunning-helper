...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1049.79 | 8248.00 | 109.3% | 94.9% |
| **API bench (installed)** | 1106.29 | 7826.74 | 115.2% | — |
| **hipblaslt-bench (stock)** | 960.11 | 9018.44 | — | — |

> **Tuned/API ratio (gate metric):** 94.89%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 14336 -n 4096 -k 73728 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,14336,4096,73728,1,14336,1056964608,0,4096,301989888,14336,58720256,14336,58720256,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,960106,292.803,9018.44
