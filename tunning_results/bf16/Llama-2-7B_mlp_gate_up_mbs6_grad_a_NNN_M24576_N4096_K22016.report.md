...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1360.12 | 3258.83 | 182.8% | 165.0% |
| **API bench (installed)** | 824.48 | 5375.99 | 110.8% | — |
| **hipblaslt-bench (stock)** | 744.13 | 5956.50 | — | — |

> **Tuned/API ratio (gate metric):** 164.97%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 24576 -k 22016 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,24576,22016,1,4096,90177536,0,22016,541065216,4096,100663296,4096,100663296,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,744129,228.873,5956.5
