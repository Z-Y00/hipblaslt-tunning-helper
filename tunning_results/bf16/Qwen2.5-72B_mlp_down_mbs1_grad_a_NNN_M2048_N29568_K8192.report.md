...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1109.79 | 893.98 | 100.0% | 87.2% |
| **API bench (installed)** | 1272.93 | 779.41 | 114.7% | — |
| **hipblaslt-bench (stock)** | 1110.11 | 893.73 | — | — |

> **Tuned/API ratio (gate metric):** 87.18%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 29568 -n 2048 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,29568,2048,8192,1,29568,242221056,0,8192,16777216,29568,60555264,29568,60555264,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.11011e+06,665.988,893.732
