...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1324.72 | 1659.99 | 114.1% | 98.7% |
| **API bench (installed)** | 1341.56 | 1639.16 | 115.6% | — |
| **hipblaslt-bench (stock)** | 1160.74 | 1894.50 | — | — |

> **Tuned/API ratio (gate metric):** 98.75%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 65536 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,65536,4096,1,4096,16777216,0,4096,268435456,4096,268435456,4096,268435456,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.16074e+06,544.339,1894.5
