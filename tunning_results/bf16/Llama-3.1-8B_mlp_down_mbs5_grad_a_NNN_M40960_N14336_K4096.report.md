...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1405.41 | 3422.75 | 114.0% | 99.4% |
| **API bench (installed)** | 1413.93 | 3402.12 | 114.7% | — |
| **hipblaslt-bench (stock)** | 1232.76 | 3902.12 | — | — |

> **Tuned/API ratio (gate metric):** 99.40%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 14336 -n 40960 -k 4096 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,14336,40960,4096,1,14336,58720256,0,4096,167772160,14336,587202560,14336,587202560,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.23276e+06,388.411,3902.12
