...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1244.62 | 5410.88 | 115.1% | 99.8% |
| **API bench (installed)** | 1246.97 | 5400.69 | 115.3% | — |
| **hipblaslt-bench (stock)** | 1081.41 | 6227.50 | — | — |

> **Tuned/API ratio (gate metric):** 99.81%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 14336 -k 57344 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,4096,14336,57344,1,4096,234881024,0,14336,822083584,4096,58720256,4096,58720256,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.08141e+06,333.701,6227.5
