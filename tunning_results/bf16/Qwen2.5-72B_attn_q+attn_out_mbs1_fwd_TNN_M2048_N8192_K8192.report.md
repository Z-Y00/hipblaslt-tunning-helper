# Qwen2.5-72B — attn_q+attn_out [fwd]
...
| **API bench (installed)** | 1220.44 | 225.23 | 114.2% | — |
| **hipblaslt-bench (stock)** | 1068.94 | 257.15 | — | — |
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 2048 -k 8192 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 1400 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,8192,2048,8192,1,8192,67108864,0,8192,16777216,8192,16777216,8192,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,1400,1,1,1.06894e+06,729.149,257.149
