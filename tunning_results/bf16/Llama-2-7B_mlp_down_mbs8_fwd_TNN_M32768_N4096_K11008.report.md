...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1483.40 | 1992.00 | 115.8% | 100.0% |
| **API bench (installed)** | 1483.53 | 1991.83 | 115.8% | — |
| **hipblaslt-bench (stock)** | 1281.49 | 2305.86 | — | — |

> **Tuned/API ratio (gate metric):** 99.99%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 32768 -k 11008 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,4096,32768,11008,1,11008,45088768,0,11008,360710144,4096,134217728,4096,134217728,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.28149e+06,436.219,2305.86
