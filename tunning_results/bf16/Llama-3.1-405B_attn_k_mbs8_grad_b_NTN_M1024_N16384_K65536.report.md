...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 475.27 | 4626.88 | 386.1% | 393.2% |
| **API bench (installed)** | 120.87 | 18193.76 | 98.2% | — |
| **hipblaslt-bench (stock)** | 123.10 | 17863.40 | — | — |

> **Tuned/API ratio (gate metric):** 393.22%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 1024 -k 65536 --precision bf16_r --compute_type f32_r --transA N --transB T -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,T,0,1,16384,1024,65536,1,16384,1073741824,0,1024,67108864,16384,16777216,16384,16777216,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,123102,120.707,17863.4
