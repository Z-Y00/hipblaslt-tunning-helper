...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1332.02 | 5778.12 | 111.9% | 95.8% |
| **API bench (installed)** | 1390.16 | 5536.46 | 116.7% | — |
| **hipblaslt-bench (stock)** | 1190.73 | 6463.76 | — | — |

> **Tuned/API ratio (gate metric):** 95.82%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 14336 -n 65536 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,14336,65536,4096,1,4096,58720256,0,4096,268435456,14336,939524096,14336,939524096,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.19073e+06,365.016,6463.76
