...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1427.77 | 1155.13 | 296.0% | 314.9% |
| **API bench (installed)** | 453.40 | 3637.56 | 94.0% | — |
| **hipblaslt-bench (stock)** | 482.30 | 3419.60 | — | — |

> **Tuned/API ratio (gate metric):** 314.90%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 12288 -n 16384 -k 4096 --precision bf16_r --compute_type f32_r --transA T --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    T,N,0,1,12288,16384,4096,1,4096,50331648,0,4096,67108864,12288,201326592,12288,201326592,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,482298,173.631,3419.6
