...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1216.73 | 3162.82 | 98.2% | 85.4% |
| **API bench (installed)** | 1424.51 | 2701.48 | 115.0% | — |
| **hipblaslt-bench (stock)** | 1238.82 | 3106.42 | — | — |

> **Tuned/API ratio (gate metric):** 85.41%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 28672 -n 8192 -k 8192 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --use_gpu_timer --flush --initialization trig_float --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,28672,8192,8192,1,28672,234881024,0,8192,67108864,28672,234881024,28672,234881024,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,1,1,1.23882e+06,321.913,3106.42
