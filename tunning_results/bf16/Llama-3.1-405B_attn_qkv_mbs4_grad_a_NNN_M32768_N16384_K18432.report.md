...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1340.21 | 14767.30 | 112.9% | 99.7% |
| **API bench (installed)** | 1343.93 | 14726.35 | 113.2% | — |
| **hipblaslt-bench (stock)** | 1186.78 | 16676.40 | — | — |

> **Tuned/API ratio (gate metric):** 99.72%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 16384 -n 32768 -k 18432 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,16384,32768,18432,1,16384,301989888,0,18432,603979776,16384,536870912,16384,536870912,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.18678e+06,161.155,16676.4
