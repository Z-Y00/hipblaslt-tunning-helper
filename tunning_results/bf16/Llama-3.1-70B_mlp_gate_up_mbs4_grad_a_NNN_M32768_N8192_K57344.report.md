# Llama-3.1-70B — mlp_gate_up [grad_a]
...
| **API bench (installed)** | 1300.39 | 23674.73 | 119.8% | — |
| **hipblaslt-bench (stock)** | 1085.53 | 28360.60 | — | — |
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 8192 -n 32768 -k 57344 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 0 --print_kernel_info
```
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,8192,32768,57344,1,8192,469762048,0,57344,1879048192,8192,268435456,8192,268435456,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,0,0,0,1.08553e+06,171.894,28360.6
