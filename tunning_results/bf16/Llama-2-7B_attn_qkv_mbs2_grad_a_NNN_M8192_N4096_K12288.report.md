...
|--------|-------:|----------:|---------:|-------:|
| **Tensile tuned** | 1436.79 | 573.94 | 208.0% | 180.9% |
| **API bench (installed)** | 794.43 | 1038.02 | 115.0% | — |
| **hipblaslt-bench (stock)** | 690.66 | 1193.98 | — | — |

> **Tuned/API ratio (gate metric):** 180.86%
...
```bash
/opt/rocm/bin/hipblaslt-bench -m 4096 -n 8192 -k 12288 --precision bf16_r --compute_type f32_r --transA N --transB N -i 50 -j 30 --rotating 2080 --print_kernel_info
```
...
Rotating buffer 2080 MiB. Needed Size: 352 MiB. Needed block count: 1 (Capped to max iters: 50)
...
[0]:transA,transB,grouped_gemm,batch_count,m,n,k,alpha,lda,stride_a,beta,ldb,stride_b,ldc,stride_c,ldd,stride_d,a_type,b_type,c_type,d_type,compute_type,scaleA,scaleB,scaleC,scaleD,amaxD,swizzle_a,swizzle_b,activation_type,bias_vector,bias_type,aux_type,rotating_buffer,flush,use_gpu_timer,hipblaslt-Gflops,hipblaslt-GB/s,us
    N,N,0,1,4096,8192,12288,1,4096,50331648,0,12288,100663296,4096,33554432,4096,33554432,bf16_r,bf16_r,bf16_r,bf16_r,f32_r,0,0,0,0,0,0,0,none,0,bf16_r,bf16_r,2080,0,0,690660,287.903,1193.98
